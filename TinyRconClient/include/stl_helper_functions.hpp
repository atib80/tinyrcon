...
#define trace_to_cerr tracer(std::cerr, __FILE__, __LINE__)
  ...
  std::u8string get_type_name_wstr(T &&t)
  {
    ...
    std::transform(std::cbegin(cstr), std::cend(cstr), std::begin(u8str), [](const auto ch)
  ...
  std::wstring get_type_name_wstr(T &&t)
  {
    ...
    std::transform(std::cbegin(cstr), std::cend(cstr), std::begin(wstr), [](const auto ch)
  ...
  std::u16string get_type_name_u16str(T &&t)
  {
    ...
    std::transform(std::cbegin(cstr), std::cend(cstr), std::begin(u16str), [](const auto ch)
  ...
  std::u32string get_type_name_u32str(T &&t)
  {
    ...
    std::transform(std::cbegin(cstr), std::cend(cstr), std::begin(u32str), [](const auto ch)
...
#define Auto(...) SetUpTaskToRunAtScopeExit(__COUNTER__, __VA_ARGS__)
  ...
  {
    static constexpr bool value = 1U == std::rank_v<T> && is_valid_char_type_v<std::remove_extent_t<T>> && !std::is_const_v<std::remove_extent_t<T>>;
  };
  ...
  template <typename T,
            typename = std::enable_if_t<
                std::is_same_v<T, std::nullptr_t> || is_char_pointer_type_v<T> || is_valid_string_view_type_v<T> || is_valid_char_type_v<T>>>
  ...
  template <
      ...
      typename U,
      typename = std::enable_if_t<(
                                      is_char_array_type_v<T> || is_char_pointer_type_v<T> || is_valid_string_type_v<T> || is_valid_string_view_type_v<T>) &&
                                  (is_char_array_type_v<U> || is_char_pointer_type_v<U> || is_valid_string_type_v<U> || is_valid_string_view_type_v<U> || is_valid_char_type_v<U>) && std::is_same_v<get_char_type_t<T>, get_char_type_t<U>>>>
                      ...
                      const std::locale &loc = std::locale{})
  {
    ...
    if constexpr (is_valid_char_type_v<U>)
    {
      ...
      if (std::has_facet<std::ctype<char_type>>(loc))
      {
        ...
        std::transform(std::cbegin(src_sv), std::cend(src_sv), std::begin(src_lc), [&f](const auto ch)
                       { return f.tolower(ch); });
    ...
    else
    {
      ...
      if (std::has_facet<std::ctype<char_type>>(loc))
      {
        ...
        std::transform(std::cbegin(src_sv), std::cend(src_sv), std::begin(src_lc), [&f](const auto ch)
                       { return f.tolower(ch); });
        std::transform(std::cbegin(needle_sv), std::cend(needle_sv), std::begin(needle_lc), [&f](const auto ch)
                       { return f.tolower(ch); });
      }
      else
      {
                                      ...
                                      const std::locale &loc = std::locale{})
  {
    ...
    {
      std::transform(
          std::cbegin(src_sv), std::cend(src_sv), std::begin(src_lc), [](const auto ch)
          { return static_cast<char_type>(std::tolower(ch)); });
      std::transform(
          std::cbegin(needle_sv), std::cend(needle_sv), std::begin(needle_lc), [](const auto ch)
          { return static_cast<char_type>(std::tolower(ch)); });
    }
                                                  ...
                                                  ContainerType &haystack)
  {
    ...
    if constexpr (!stl::helper::has_find_member_function_v<ContainerType, T> && ((stl::helper::has_sort_member_function_v<ContainerType> && stl::helper::is_operator_less_than_defined_v<U>) || stl::helper::is_operator_less_than_defined_v<U>))
    {
      ...
      const std::locale &loc = std::locale{})
  {
    ...
    if constexpr (is_valid_char_type_v<U>)
    {
      ...
      if (std::has_facet<std::ctype<char_type>>(loc))
      {
        ...
        std::transform(std::cbegin(src_lc), std::cend(src_lc), std::begin(src_lc), [&f](const auto ch)
                       { return f.tolower(ch); });
        needle_lc = f.tolower(needle);
      }
      else
    ...
    else
    {
      ...
      if (std::has_facet<std::ctype<char_type>>(loc))
      {
        ...
        std::transform(std::cbegin(src_lc), std::cend(src_lc), std::begin(src_lc), [&f](const auto ch)
                       { return f.tolower(ch); });
        std::transform(std::cbegin(needle_lc), std::cend(needle_lc), std::begin(needle_lc), [&f](const auto ch)
                       { return f.tolower(ch); });
      }
      else
      {
  ...
  inline bool has_value(const ContainerType &container, const ValueType &value)
  {
    ...
    {
      return std::any_of(std::cbegin(container), std::cend(container), [&value](const auto &p)
    ...
    else if constexpr (has_value_type_v<ContainerType> && check_equality_v<typename ContainerType::value_type, std::remove_reference_t<ValueType>>)
    {
                          ...
                          const typename ContainerType::value_type &key_value_pair)
  {
    ...
    for (auto current{first_item_iter_pos.first};
         current != first_item_iter_pos.second;
         ++current)
    {
  ...
  template <typename T,
            typename U,
            typename = std::enable_if_t<
                (is_char_array_type_v<T> || is_char_pointer_type_v<T> || is_valid_string_type_v<T> || is_valid_string_view_type_v<T>) && (is_char_array_type_v<U> || is_char_pointer_type_v<U> || is_valid_string_type_v<U> || is_valid_string_view_type_v<U>) && std::is_same_v<get_char_type_t<T>, get_char_type_t<U>>>>
                         ...
                         FwIterType2 last2)
  {
    ...
    for (std::common_type_t<
             ...
             typename std::iterator_traits<FwIterType2>::difference_type>
             i{};
         i < number_of_characters_to_compare;
         ++i, ++first1, ++first2)
    {
      if (*first1 != *first2)
  ...
  template <
      ...
      typename U,
      typename = std::enable_if_t<
          is_valid_char_type_v<T> && !std::is_const_v<T> && (is_char_array_type_v<U> || is_char_pointer_type_v<U> || is_valid_string_type_v<U> || is_valid_string_view_type_v<U>) && std::is_same_v<std::remove_cv_t<T>, get_char_type_t<U>>>>
  ...
  template <
      ...
      typename U,
      typename = std::enable_if_t<
          is_non_const_char_pointer_type_v<T> && (is_char_array_type_v<U> || is_char_pointer_type_v<U> || is_valid_string_type_v<U> || is_valid_string_view_type_v<U>) && std::is_same_v<get_char_type_t<T>, get_char_type_t<U>>>>
  size_t str_copy(
      T dst,
  ...
  template <typename T,
            typename U,
            typename = std::enable_if_t<
                is_valid_string_type_v<T> && !std::is_const_v<T> && (is_valid_string_type_v<U> || is_valid_string_view_type_v<U> || is_char_pointer_type_v<U>) && std::is_same_v<get_char_type_t<T>, get_char_type_t<U>>>>
  ...
  template <typename T,
            ...
            size_t ARRAY_SIZE,
            typename = std::enable_if_t<
                is_valid_string_type_v<T> && !std::is_const_v<T> && is_valid_char_type_v<U> && std::is_same_v<get_char_type_t<T>, std::remove_cv_t<U>>>>
      ...
      size_t *required_dst_capacity = nullptr)
  {
    ...
    if (copy_options == str_copy_behavior::disallow_partial_copy && dst_capacity_in_number_of_characters < required_dst_buffer_size)
      return 0U;
                    ...
                    size_t *required_dst_capacity = nullptr)
  {
    ...
    if (append_behavior == str_append_behavior::disallow_partial_append && dst_capacity_in_number_of_characters < required_dst_buffer_size)
      return 0U;
  ...
  template <typename T,
            typename U,
            typename = std::enable_if_t<
                (is_valid_string_type_v<T> || is_valid_string_view_type_v<T> || is_char_pointer_type_v<T> || is_char_array_type_v<T>) && (is_valid_string_type_v<U> || is_valid_string_view_type_v<U> || is_char_pointer_type_v<U> || is_char_array_type_v<U>) && std::is_same_v<get_char_type_t<T>, get_char_type_t<U>>>>
  ...
  template <typename T,
            typename U,
            typename = std::enable_if_t<
                is_valid_string_type_v<T> && !std::is_const_v<T> && (is_valid_string_type_v<U> || is_valid_string_view_type_v<U> || is_char_pointer_type_v<U> || is_char_array_type_v<U>) && std::is_same_v<get_char_type_t<T>, get_char_type_t<U>>>>
  size_t str_append(T &dst,
                    const U &src,
                    size_t *required_dst_capacity = nullptr)
  {
                      ...
                      size_t *required_dst_capacity = nullptr)
  {
    ...
    if (append_options == str_append_behavior::disallow_partial_append && dst_capacity_in_number_of_characters < required_dst_buffer_size)
      return 0U;
                     ...
                     size_t *required_dst_capacity = nullptr)
  {
    ...
    if (prepend_options == str_prepend_behaviour::disallow_partial_prepend && dst_capacity_in_number_of_characters < required_dst_size)
      return 0U;
                       ...
                       size_t *required_dst_capacity = nullptr)
  {
    ...
    if (prepend_options == str_prepend_behaviour::disallow_partial_prepend && dst_capacity_in_number_of_characters < required_dst_buffer_size)
      return 0U;
      ...
      size_t *required_dst_capacity = nullptr)
  {
    ...
    if (0U == dst_len)
      return std::basic_string<char_type>{std::cbegin(src_sv) + std::cbegin(src_sv) + number_of_characters_to_prepend};
                    ...
                    size_t *required_dst_capacity = nullptr)
  {
    ...
    if (0U == src_len || position_index_in_dst > dst_len || (insert_options == str_insert_behaviour::disallow_partial_insert && ARRAY_SIZE < required_dst_buffer_size))
      return 0U;
                    ...
                    size_t *required_dst_capacity = nullptr)
  {
    ...
    if (position_index_in_dst > dst_len || 0U == src_len || (insert_options == str_insert_behaviour::disallow_partial_insert && dst_capacity_in_number_of_characters < required_dst_buffer_size))
      return 0U;
                      ...
                      size_t *required_dst_capacity = nullptr)
  {
    ...
    if (0U == src_len || position_index_in_dst > dst_len || (insert_options == str_insert_behaviour::disallow_partial_insert && ARRAY_SIZE < required_dst_size))
      return 0U;
                      ...
                      size_t *required_dst_capacity = nullptr)
  {
    ...
    if (0U == src_len || position_index_in_dst > dst_len || (insert_options == str_insert_behaviour::disallow_partial_insert && dst_capacity_in_number_of_characters < required_dst_size))
      return 0U;
                    ...
                    size_t *required_dst_capacity = nullptr)
  {
    ...
    dst.insert(std::begin(dst) + position_index_in_dst, std::cbegin(src_sv), std::cbegin(src_sv) + number_of_characters_to_insert);
  }

  template <typename T,
            typename = std::enable_if_t<
                is_valid_string_type_v<T> || is_valid_string_view_type_v<T> || is_char_pointer_type_v<T> || is_char_array_type_v<T>>>
  ...
  template <
      ...
      typename V,
      typename = std::enable_if_t<
          is_valid_char_type_v<T> && !std::is_const_v<T> && (is_valid_char_type_v<U> || is_char_array_type_v<U> || is_char_pointer_type_v<U> || is_valid_string_type_v<U> || is_valid_string_view_type_v<U>) && (is_valid_char_type_v<V> || is_char_array_type_v<V> || is_char_pointer_type_v<V> || is_valid_string_type_v<V> || is_valid_string_view_type_v<V>) && is_all_of_v<std::remove_cv_t<T>, get_char_type_t<U>, get_char_type_t<V>>>>
  ...
  template <
      ...
      typename V,
      typename = std::enable_if_t<
          is_non_const_char_pointer_type_v<T> && (is_valid_char_type_v<U> || is_char_array_type_v<U> || is_char_pointer_type_v<U> || is_valid_string_type_v<U> || is_valid_string_view_type_v<U>) && (is_valid_char_type_v<V> || is_char_array_type_v<V> || is_char_pointer_type_v<V> || is_valid_string_type_v<V> || is_valid_string_view_type_v<V>) && is_all_of_v<get_char_type_t<T>, get_char_type_t<U>, get_char_type_t<V>>>>
  size_t str_replace_first(
      T dst,
      const size_t dst_capacity_in_number_of_characters,
      const U &needle,
  ...
  template <
      ...
      typename = std::enable_if_t<(
                                      is_valid_string_type_v<T> || is_valid_string_view_type_v<T> || is_char_pointer_type_v<T> || is_char_array_type_v<T>) &&
                                  (is_valid_char_type_v<U> || is_valid_string_type_v<U> || is_valid_string_view_type_v<U> || is_char_pointer_type_v<U> || is_char_array_type_v<U>) && (is_valid_char_type_v<V> || is_valid_string_type_v<V> || is_valid_string_view_type_v<V> || is_char_pointer_type_v<V> || is_char_array_type_v<V>) && is_all_of_v<get_char_type_t<T>, get_char_type_t<U>, get_char_type_t<V>>>>
  ...
  template <
      ...
      typename V,
      typename = std::enable_if_t<
          is_valid_string_type_v<T> && !std::is_const_v<T> && (is_valid_char_type_v<U> || is_valid_string_type_v<U> || is_valid_string_view_type_v<U> || is_char_pointer_type_v<U> || is_char_array_type_v<U>) && (is_valid_char_type_v<V> || is_valid_string_type_v<V> || is_valid_string_view_type_v<V> || is_char_pointer_type_v<V> || is_char_array_type_v<V>) && is_all_of_v<get_char_type_t<T>, get_char_type_t<U>, get_char_type_t<V>>>>
  size_t str_replace_first(
      T &dst,
      const U &needle,
      const V &replace,
                         ...
                         size_t *required_dst_capacity = nullptr)
  {
    ...
    const size_t required_dst_buffer_size{
        dst_len - needle_start_positions.size() * needle_len + needle_start_positions.size() * replace_len + 1};
  ...
  template <typename T,
            ...
            typename U,
            typename = std::enable_if_t<
                is_valid_char_type_v<T> && !std::is_const_v<T> && (is_valid_char_type_v<U> || is_char_array_type_v<U> || is_char_pointer_type_v<U> || is_valid_string_type_v<U> || is_valid_string_view_type_v<U>) && std::is_same_v<std::remove_cv_t<T>, get_char_type_t<U>>>>
  ...
  template <typename T,
            typename U,
            typename = std::enable_if_t<
                is_non_const_char_pointer_type_v<T> && (is_valid_char_type_v<U> || is_char_array_type_v<U> || is_char_pointer_type_v<U> || is_valid_string_type_v<U> || is_valid_string_view_type_v<U>) && std::is_same_v<get_char_type_t<T>, get_char_type_t<U>>>>
  ...
  template <
      ...
      typename = std::enable_if_t<(
                                      is_valid_string_type_v<T> || is_valid_string_view_type_v<T> || is_char_pointer_type_v<T> || is_char_array_type_v<T>) &&
                                  (is_valid_char_type_v<U> || is_valid_string_type_v<U> || is_valid_string_view_type_v<U> || is_char_pointer_type_v<U> || is_char_array_type_v<U>) && std::is_same_v<get_char_type_t<T>, get_char_type_t<U>>>>
  ...
  template <typename T,
            typename U,
            typename = std::enable_if_t<
                is_valid_string_type_v<T> && !std::is_const_v<T> && (is_valid_char_type_v<U> || is_valid_string_type_v<U> || is_valid_string_view_type_v<U> || is_char_pointer_type_v<U> || is_char_array_type_v<U>) && std::is_same_v<get_char_type_t<T>, get_char_type_t<U>>>>
  size_t str_erase_first(T &dst,
                         const U &needle,
                         const size_t start_position_in_dst = 0U,
                         const bool ignore_case_when_searching_for_needle = false,
  ...
  template <typename T,
            ...
            typename U,
            typename = std::enable_if_t<
                is_valid_char_type_v<T> && !std::is_const_v<T> && (is_valid_char_type_v<U> || is_char_array_type_v<U> || is_char_pointer_type_v<U> || is_valid_string_type_v<U> || is_valid_string_view_type_v<U>) && is_all_of_v<std::remove_cv_t<T>, get_char_type_t<U>>>>
  size_t str_replace_last_n(
      T (&dst)[ARRAY_SIZE],
      const U &needle,
      const size_t last_n_needle_count,
  ...
  template <typename T,
            typename U,
            typename = std::enable_if_t<
                (is_char_pointer_type_v<T> || is_char_array_type_v<T>) && (is_char_pointer_type_v<U> || is_char_array_type_v<U>) && std::is_same_v<get_char_type_t<T>, get_char_type_t<U>>>>
  ...
  template <
      ...
      typename U,
      typename = std::enable_if_t<
          (is_valid_string_type_v<T> || is_valid_string_view_type_v<T>) && (is_valid_string_type_v<U> || is_valid_string_view_type_v<U>) && (std::is_same_v<get_char_type_t<T>, get_char_type_t<U>>)>>
  ...
  template <
      ...
      typename U,
      typename = std::enable_if_t<
          (is_char_array_type_v<T> || is_char_pointer_type_v<T>) && (is_char_array_type_v<U> || is_char_pointer_type_v<U>) && (std::is_same_v<get_char_type_t<T>, get_char_type_t<U>>)>>
  auto strstri(T src, U needle, const std::locale &loc = std::locale{})
  {
    ...
    if (std::has_facet<std::ctype<char_type>>(loc))
    {
      ...
      std::transform(src_sv.cbegin(), src_sv.cend(), std::begin(src_lc), [&f](const auto ch)
                     { return f.tolower(ch); });

      std::transform(needle_sv.cbegin(), needle_sv.cend(), std::begin(needle_lc), [&f](const auto ch)
                     { return f.tolower(ch); });
    }
    else
    {
      std::transform(
          src_sv.cbegin(), src_sv.cend(), std::begin(src_lc), [](const auto ch)
          { return static_cast<char_type>(std::tolower(ch)); });

      std::transform(
          needle_sv.cbegin(), needle_sv.cend(), std::begin(needle_lc), [](const auto ch)
          { return static_cast<char_type>(std::tolower(ch)); });
    }
                 ...
                 const std::locale &loc = std::locale{})
  {
    ...
    {
      std::transform(
          std::cbegin(src_lc), std::cend(src_lc), std::begin(src_lc), [](const auto ch)
          { return static_cast<char_type>(std::tolower(ch)); });

      std::transform(
          std::cbegin(needle_lc), std::cend(needle_lc), std::begin(needle_lc), [](const auto ch)
          { return static_cast<char_type>(std::tolower(ch)); });
    }
  ...
  template <typename T,
            typename = std::enable_if_t<is_non_const_char_array_type_v<T> || is_non_const_char_pointer_type_v<T> || is_valid_string_type_v<T>>>
  void to_lower_case_in_place(T &src, const std::locale &loc = std::locale{})
  {
    ...
    {
      const auto &f = std::use_facet<std::ctype<char_type>>(loc);
      std::transform(first, first + str_len, first, [&f](const auto ch)
                     { return f.tolower(ch); });
    }
    else
    {
      ...
      const std::locale &loc = std::locale{})
  {
    ...
    {
      const auto &f = std::use_facet<std::ctype<char_type>>(loc);
      std::transform(src_sv.cbegin(), src_sv.cend(), std::begin(src_uc), [&f](const auto ch)
                     { return f.toupper(ch); });
    }
    else
    {
      std::transform(src_sv.cbegin(), src_sv.cend(), std::begin(src_uc), [](const auto ch)
  ...
  void to_upper_case_in_place(T &src, const std::locale &loc = std::locale{})
  {
    ...
    {
      const auto &f = std::use_facet<std::ctype<char_type>>(loc);
      std::transform(first, first + src_len, first, [&f](const auto ch)
                     { return f.toupper(ch); });
    }
    else
    {
          ...
          add_number_base_sign::no_number_base_sign)
  {
    ...
    if (add_number_base_sign::prepend_in_lower_case_format == number_base_sign_location || add_number_base_sign::prepend_in_upper_case_format == number_base_sign_location)
    {
      first_digit_pos += 2;
          ...
          std::numeric_limits<remove_cv_ref_t<T>>::digits10)
  {
    ...
    std::transform(buffer, buffer + buffer_len + 1, std::back_inserter(number_str), [](const auto ch)
                   { return static_cast<char16_t>(ch); });
           ...
           size_t *pos = nullptr)
  {
    ...
    if (number_base::binary == base && (static_cast<char_type>('b') == src_sv[0] || static_cast<char_type>('B') == src_sv[0]))
      ++itr;

    else if (number_base::binary == base && 0 == str_compare_n_i(src_sv, binary_number_base_prefix, 2))
      itr += 2;

    else if (number_base::octal == base && (static_cast<char_type>('0') == src_sv[0] || static_cast<char_type>('o') == src_sv[0] || static_cast<char_type>('O') == src_sv[0]))
      ++itr;

    else if (number_base::octal == base && 0 == str_compare_n_i(src_sv, octal_number_base_prefix, 2))
      itr += 2;

    else if (number_base::hexadecimal == base && (static_cast<char_type>('x') == src_sv[0] || static_cast<char_type>('X') == src_sv[0]))
      ++itr;
    ...
    for (; !found_invalid_character && itr != std::cend(src_sv); ++itr)
    {
      ...
      case number_base::hexadecimal:
        if ((ch >= static_cast<char_type>('0') && ch <= static_cast<char_type>('9')) || (ch >= static_cast<char_type>('A') && ch <= static_cast<char_type>('F')) || (ch >= static_cast<char_type>('a') && ch <= static_cast<char_type>('f')))
        {
          number_value *= 16;
          if (ch >= static_cast<char_type>('0') && ch <= static_cast<char_type>('9'))
            number_value += static_cast<int>(ch - static_cast<char_type>('0'));
             ...
             size_t *pos = nullptr)
  {
    ...
    else if (number_base::binary == base && 0 == str_compare_n_i(itr, std::cend(src_sv), std::cbegin(binary_number_base_prefix), std::cend(binary_number_base_prefix), 2))
      itr += 2;

    else if (number_base::octal == base && (static_cast<char_type>('0') == *itr || static_cast<char_type>('o') == *itr || static_cast<char_type>('O') == *itr))
      ++itr;

    else if (number_base::octal == base && 0 == str_compare_n_i(itr, std::cend(src_sv), std::cbegin(octal_number_base_prefix), std::cend(octal_number_base_prefix), 2))
      itr += 2;

    else if (number_base::hexadecimal == base && (static_cast<char_type>('x') == *itr || static_cast<char_type>('X') == *itr))
      ++itr;

    else if (number_base::hexadecimal == base && 0 == str_compare_n_i(itr, std::cend(src_sv), std::cbegin(hexadecimal_number_base_prefix), std::cend(hexadecimal_number_base_prefix), 2))
      itr += 2;
    ...
    if (base != number_base::hexadecimal && (*itr == static_cast<char_type>('e') || *itr == static_cast<char_type>('E')))
    {
    ...
    for (; !found_invalid_character && i != src_sv.length(); ++i)
    {
      ...
      case number_base::binary:
        ...
        else if (!exponential_sign_found && (src_sv[i] == static_cast<char_type>('e') || src_sv[i] == static_cast<char_type>('E')))
          exponential_sign_found = true;
        ...
        else
        {
          ...
          else if (fractional_part_found)
          {
            fractional_part_value +=
                static_cast<float>((src_sv[i] - static_cast<char_type>('0')) * std::pow(2, fractional_part_position_index));
      ...
      case number_base::octal:
        ...
        else
        {
          ...
          {
            fractional_part_value +=
                static_cast<float>((src_sv[i] - static_cast<char_type>('0')) * std::pow(8, fractional_part_position_index));
            fractional_part_position_index--;
          }
          else
          {
        ...
        else
        {
          ...
          else if (fractional_part_found)
          {
            fractional_part_value += static_cast<float>(
                (src_sv[i] - static_cast<char_type>('0')) * std::pow(10, fractional_part_position_index));
            fractional_part_position_index--;
          }
          else
          {
      ...
      case number_base::hexadecimal:
        ...
        else
        {
          if (fractional_part_found)
          {
            if ((src_sv[i] >= static_cast<char_type>('0') && src_sv[i] <= static_cast<char_type>('9')) || (src_sv[i] >= static_cast<char_type>('A') && src_sv[i] <= static_cast<char_type>('F')) || (src_sv[i] >= static_cast<char_type>('a') && src_sv[i] <= static_cast<char_type>('f')))
            {
              number_value *= 16;

              if (src_sv[i] >= static_cast<char_type>('0') && src_sv[i] <= static_cast<char_type>('9'))
                fractional_part_value += static_cast<float>(
                    (src_sv[i] - static_cast<char_type>('0')) * std::pow(16, fractional_part_position_index));

              else if (src_sv[i] >= static_cast<char_type>('A') && src_sv[i] <= static_cast<char_type>('F'))
                fractional_part_value += static_cast<float>(
                    (src_sv[i] - static_cast<char_type>('A')) * std::pow(16, fractional_part_position_index));
    ...
    for (; !found_invalid_character && i != src_sv.length(); ++i)
    {
        ...
        else
        {
          ...
          else if (fractional_part_found)
          {
            fractional_part_value += static_cast<double>(
                (src_sv[i] - static_cast<char_type>('0')) * std::pow(2, fractional_part_position_index));
            fractional_part_position_index--;
          }
          else
          {
      ...
      case number_base::octal:
        ...
        else
        {
          ...
          {
            fractional_part_value += static_cast<double>(
                (src_sv[i] - static_cast<char_type>('0')) * std::pow(8, fractional_part_position_index));
            fractional_part_position_index--;
          }
          else
          {
  ...
  template <
      ...
      typename = std::enable_if_t<(
                                      is_valid_string_type_v<T> || is_valid_string_view_type_v<T> || is_char_array_type_v<T> || is_char_pointer_type_v<T>) &&
                                  (is_valid_string_type_v<U> || is_valid_string_view_type_v<U> || is_char_array_type_v<U> || is_char_pointer_type_v<U> || is_valid_char_type_v<U>) && (is_valid_string_type_v<V> || is_valid_string_view_type_v<V> || is_char_array_type_v<V> || is_char_pointer_type_v<V> || is_valid_char_type_v<V> || std::is_same_v<V, std::nullptr_t>) && ((std::is_same_v<get_char_type_t<T>, get_char_type_t<U>> && std::is_same_v<V, std::nullptr_t>) || is_all_of_v<get_char_type_t<T>, get_char_type_t<U>, get_char_type_t<V>>)>>
  ...
  template <typename T,
            typename U,
            typename = std::enable_if_t<
                is_valid_char_type_v<T> || is_char_array_type_v<T> || is_char_pointer_type_v<T> || is_valid_string_type_v<T> || is_valid_string_view_type_v<T>>>
  ...
  template <typename ContainerType,
            typename NeedleType,
            typename = std::enable_if_t<
                (is_valid_char_type_v<NeedleType> || is_char_pointer_type_v<NeedleType> || is_char_array_type_v<NeedleType> || is_valid_string_type_v<NeedleType> || is_valid_string_view_type_v<NeedleType>) && has_cbegin_member_function_v<ContainerType> && has_cend_member_function_v<ContainerType> && has_output_stream_operator_v<std::basic_ostream<get_char_type_t<NeedleType>>, typename ContainerType::value_type>>>
  ...
  template <
      ...
      typename NeedleType,
      typename = std::enable_if_t<(
                                      is_valid_char_type_v<NeedleType> || is_char_pointer_type_v<NeedleType> || is_char_array_type_v<NeedleType> || is_valid_string_type_v<NeedleType> || is_valid_string_view_type_v<NeedleType>) &&
                                  has_output_stream_operator_v<std::
                                                                   basic_ostream<
                                                                       get_char_type_t<
                                                                           NeedleType>>,
                                                               typename std::
