...
public:
  ...
  void prepare_non_rcon_command(char *buffer, const std::size_t buffer_size, const char *command_to_send) const noexcept;
  ...
  size_t receive_rcon_reply_from_server(const char *remote_ip, const uint_least16_t remote_port, std::string &reply_buffer, const bool is_process_reply = true) const;

  size_t receive_non_rcon_reply_from_server(const char *remote_ip, const uint_least16_t remote_port, std::string &reply_buffer, const bool is_process_reply = true) const;
  ...
  void send_and_receive_non_rcon_data(const char *command_to_send, std::string &reply_buffer, const char *remote_ip, const uint_least16_t remote_port, const bool is_wait_for_reply = true, const bool is_process_reply = true) const;
