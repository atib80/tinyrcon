...
#define SQLITE_DBCONFIG_MAX 1019                   /* Largest DBCONFIG */
    ...
    ** type of SQL statement does not modify the value returned by these
    *functions.
    **
...
#define SQLITE3_TEXT 3
    ...
    ** <tr><td>  BLOB    <td>   TEXT    <td> [CAST] to TEXT, ensure zero
    *terminator
    ** </table>
    ** </blockquote>)^
    **
...
*/
    ...
    */
    ...
    /*
    ** CAPI3REF: Report the internal text encoding state of an sqlite3_value
    *object
    ** METHOD: sqlite3_value
    **
    ** ^(The sqlite3_value_encoding(X) interface returns one of [SQLITE_UTF8],
    ** [SQLITE_UTF16BE], or [SQLITE_UTF16LE] according to the current text
    *encoding
...
#define SQLITE_TRANSIENT ((sqlite3_destructor_type) - 1)
    ...
    ** argument passed into sqlite3_sleep() is changed to zero before it is
    *relayed
...
#define SQLITE_WIN32_TEMP_DIRECTORY_TYPE 2
    ...
    ** remember the string long-term should make their own copy.  Applications
    *that
...
#define SQLITE_VTAB_USES_ALL_SCHEMAS 4
    ...
    **
    ** <ol>
    ** <li><p> If the constraint comes from a WHERE clause expression that
    *contains
    ...
    ** that the query planner does not need the rows to be returned in sorted
    *order
    ...
    ** needs to be returned.)^  ^It is always ok for two or more rows with the
    *same
    ...
    ** a copy of the [sqlite3_index_info] object pointer passed into xBestIndex
    *and
...
typedef double sqlite3_rtree_dbl;
    ...
    */
    SQLITE_API int sqlite3_rtree_geometry_callback(sqlite3 *db, const char *zGeom,
                                                   int (*xGeom)(sqlite3_rtree_geometry *, int, sqlite3_rtree_dbl *,
                                                                int *),
                                                   void *pContext);
