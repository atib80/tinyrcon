...
extern const map<string, string> user_commands_help{
	...
	{"^5!report",
	 "^5!report pid optional_reason ^2-> ^3reports player (whose ^1pid ^3number is equal to specified ^1'pid'^3) with reason ^1'optional_reason'."},
	{"^5!unreport",
	 "^5!unreport ip_address optional_reason ^2-> ^3removes previously reported player whose ^1IP address is ^1'ip_address'.\n^3You can also specify an optional reason."},
	{"^5!reports", "^5!reports optional_number ^2-> ^3displays ^1all ^3or last ^1'optional_number' ^3reported players."},
	{"^5!warn",
	 "^5!warn player_pid [reason] ^2-> warns player whose pid number is equal to specified player_pid.\n A player who's been warned 2 times gets automatically kicked off the server."},
	{"^5!w",
	 "^5!w player_pid [reason] ^2-> warns player whose pid number is equal to specified player_pid.\n A player who's been warned 2 times gets automatically kicked off the server."},
	{"!kick",
	 "^5!kick player_pid [reason] ^2-> kicks player whose pid number is equal to "
	 "specified player_pid."},
	{"!k",
	 "^5!k player_pid [reason] ^2-> kicks player whose pid number is equal to specified "
	 "player_pid."},
	{"!tempban",
	...
	{"!tb",
	 ...
	 "IP address of player whose pid = ^112."},
	{"!ban",
	 "^5!ban player_pid [reason] ^2-> bans player whose pid number is equal to "
	 "specified player_pid"},
	{"!b",
	 "^5!b player_pid [reason] ^2-> bans player whose pid number is equal to specified "
	 "player_pid"},
	{"!gb",
	...
	{"!s",
	 "^5!s name ^2-> displays stats data for player with partially or fully specified player name ^1name. "
	...
	{"!banrange",
	 "^5!banrange pid|ip_address_range [reason] ^2-> ^5bans IP address range of player whose ^1pid ^5is equal to specified ^1pid ^5number."},
	{"!unbanrange",
	 "^5!unbanrange ip_address_range [reason] ^2-> ^3removes previously banned IP address range ^1ip_address_range"},
	{"!admins", "^5!admins ^2-> ^5Displays information about all registered admins."},
	{"!protectip",
	 "^5!protectip pid|ip_address [reason] ^2-> ^3protects player's ^1IP address ^3whose ^1pid number ^3or "
	 "^1IP address ^3is equal to specified ^1pid ^3or ^1ip_address^3, respectively."},
	{"!unprotectip",
	 "^5!unprotectip pid|ip_address [reason] ^2-> ^5removes protected ^1IP address ^5of player whose ^1pid number ^5or "
	 "^1IP address ^5is equal to specified ^1pid ^5or ^1ip_address^5, respectively."},
	{"!protectiprange",
	 "^5!protectiprange pid|ip_address_range [reason] ^2-> ^3protects player's ^1IP address range ^3whose ^1pid number ^3or "
	 "^1IP address range ^3is equal to specified ^1pid ^3or ^1ip_address_range^3, respectively."},
	{"!unprotectiprange",
	 "^5!unprotectiprange pid|ip_address_range [reason] ^2-> ^5removes protected ^1IP address range ^5of player whose ^1pid number ^5or "
	 "^1IP address range ^5is equal to specified ^1pid ^5or ^1ip_address_range^5, respectively."},
	{"!protectcity",
	 "^5!protectcity pid|city_name ^2-> ^3protects player's ^1city ^3whose ^1pid number ^3or "
	 "^1city name ^3is equal to specified ^1pid ^3or ^1city_name^3, respectively."},
	{"!unprotectcity",
	 "^5!unprotectcity pid|city_name ^2-> ^5removes protected ^1city ^5of player whose ^1pid number ^5or "
	 "^1city name ^5is equal to specified ^1pid ^5or ^1city_name^5, respectively."},
	{"!protectcountry",
	 "^5!protectcountry pid|country_name ^2-> ^3protects player's ^1country ^3whose ^1pid number ^3or "
...
extern const map<string, string> rcon_commands_help{
	{"status",
	 "^1status ^2-> ^3Retrieves current game state (^1players' data^3) from the server "
	 "^3(^1pid, score, ping, name, guid, ip, qport, rate^3)"},
	{"clientkick",
	 "^1clientkick player_pid [reason] ^2-> ^5Kicks player whose ^1pid ^5number is equal to "
	 "specified ^1player_pid"},
	{"kick",
	 "^1kick name [reason] ^2-> ^3Kicks player whose ^1name ^3is equal to specified ^1name"},
	{"onlykick",
	 "^1onlykick name_no_color_codes [reason] ^2-> ^5Kicks player whose ^1name ^5is equal to "
	 "specified ^1name_no_color_codes"},
	{"banclient",
	 "^1banclient player_pid [reason] ^2-> ^3Bans player whose ^1pid ^3number is equal to "
	 "specified ^1player_pid."},
	{"banuser",
	 "^1banuser name [reason] ^2-> ^5Bans player whose ^1name ^5is equal to specified ^1name."},
	{"tempbanclient",
	 "^1tempbanclient player_pid [reason] ^2-> ^3Temporarily bans player whose ^1pid ^3number is "
	 "equal to specified ^1player_pid"},
	{"tempbanuser",
	 "^1tempbanuser name [reason] ^2-> ^5Temporarily bans player whose ^1name ^5is equal to "
	 "specified ^1name"},
	{"serverinfo", "^1serverinfo ^2-> ^3Retrieves currently active server settings."},
	{"map_rotate", "^1map_rotate ^2-> ^5Loads next map on the server."},
	{"map_restart",
	 "^1map_restart ^2-> ^3Reloads currently played map on the server."},
	{"map", "^1map map_name ^2-> ^5Immediately loads map ^1map_name ^5on the server."},
	{"fast_restart",
	 "^1fast_restart ^2-> ^3Quickly restarts currently played ^1map ^3on the server."},
	{"getinfo",
	 "^1getinfo ^2-> ^5Retrieves basic server information from the server."},
	{"mapname",
	 "^1mapname ^2-> ^3Retrieves and displays currently played map's ^1rcon map name ^3on "
	 "the console."},
	{"g_gametype",
	 "^1g_gametype ^2-> ^5Retrieves and displays currently played match's ^1gametype "
	 "^5on the console."},
	{"sv_maprotation",
	 "^1sv_maprotation ^2-> ^3Retrieves and displays server's original ^1map rotation "
	 "^3setting."},
	{"sv_maprotationcurrent",
	 "^1sv_maprotationcurrent ^2-> ^5Retrieves and displays server's current ^1map "
	 "rotation ^5setting."},
	{"say", R"(^1say public_message ^2-> ^3Sends ^1public_message ^3to all players on the server.)"},
	{"tell", "^1tell player_pid private_message ^2-> ^5Sends ^1private_message ^5to player whose ^1pid ^5= ^1player_pid"}};
...
void show_error(HWND parent_window, const char *error_message, const size_t error_level)
{
	...
	main_app.get_connection_manager_for_messages().process_and_send_message("tinyrcon-error",
																			format("{}\\{}\\Error level={}\\Error message: '{}'",
	...
	const char *file_path)
{
	...
	config_file << R"("enable_tracking_of_player_stats_data_for_year": )" << (main_app.get_is_enable_tracking_of_player_stats_data_for_year() ? "true" : "false") << ",\n";
	config_file << R"("enable_tracking_of_player_stats_data_permanently": )" << (main_app.get_is_enable_tracking_of_player_stats_data_permanently() ? "true" : "false") << ",\n";
	config_file << R"("number_of_top_players_to_display_in_game_chat": )" << main_app.get_number_of_top_players_to_display_in_game_chat() << ",\n";
...
//			max(count_color_codes ? len(players[i].name) : get_number_of_characters_without_color_codes(players[i].name), max_player_name_length);
//	}
//
...
void parse_tinyrcon_tool_config_file(const char *configFileName)
{
	...
	if (json_resource.contains("rcon_game_servers") && json_resource.at("rcon_game_servers").is_array())
	{
		...
		for (size_t i{}; i < rcon_game_servers_json_array.size(); ++i)
		{
			...
			if (json_object.contains("game_server_name") && json_object.contains("rcon_server_ip_address") && json_object.contains("rcon_port") && json_object.contains("rcon_password") && json_object.contains("private_slot_password"))
			{
				game_server gs{};
...
void parse_protected_entries_file(const char *file_path, std::set<std::string> &protected_entries)
{
	...
	if (!input_file)
	{
		...
		string errorMessage{
			"^3Couldn't open file at specified path ^1("s + string{file_path} + ")^3! "s + buffer};
...
void parse_banned_countries_file(const char *file_path, std::set<std::string> &banned_countries)
{
	...
	if (!input_file)
	{
		...
		strerror_s(buffer, buffer_size, static_cast<int>(GetLastError()));
		string errorMessage{
			"Couldn't open file at specified path ("s + string{file_path} + ")! "s + buffer};
...
bool temp_ban_player_ip_address(player &pd)
{
	...
	if (!temp_banned_data_file_to_read)
	{
		...
		strerror_s(buffer, buffer_size, static_cast<int>(GetLastError()));
		string errorMessage{
			"Couldn't open 'tempbans.txt' data file at specified path ("s + string{main_app.get_temp_bans_file_path()} + ")! "s + buffer};
		show_error(app_handles.hwnd_main_window, errorMessage.c_str(), 0);
...
bool global_ban_player_ip_address(player &pd)
{
	...
	if (!bannedIPsFileToRead)
	{
		...
		strerror_s(buffer, buffer_size, static_cast<int>(GetLastError()));
		string errorMessage{
			"Couldn't open banned IP addresses data file at specified path ("s + string{main_app.get_ip_bans_file_path()} + ")! "s + buffer};
		show_error(app_handles.hwnd_main_window, errorMessage.c_str(), 0);
...
std::pair<bool, player> remove_temp_banned_ip_address(const std::string &ip_address, std::string &message, const bool is_automatic_temp_ban_remove, const bool is_report_public_message)
{
	...
	if (found_iter != std::end(temp_banned_players))
	{
		if (is_report_public_message)
		{
			...
			{
				const string buffer{
					format("^7Admin ({}^7) has manually removed ^1temporarily banned IP address ^7for player {}. ^7Reason: ^1{}",
						   main_app.get_username(),
...
std::pair<bool, player> remove_permanently_banned_ip_address(std::string &ip_address, std::string &message, const bool is_report_public_message)
{
	...
	if (main_app.get_current_game_server().get_banned_ip_addresses_map().find(
			ip_address) == cend(main_app.get_current_game_server().get_banned_ip_addresses_map()) &&
	...
	if (found_iter != std::end(banned_players))
	{
		...
		{
			const string buffer{
				format("^7Admin ({}^7) has manually removed ^1permanently banned IP address ^7for player {}. ^7Reason: ^1{}",
...
void print_help_information(const std::vector<std::string> &input_parts)
{
 ...
 ^1!report pid optional_reason ^5-> ^2reports player whose ^1pid number ^2is equal to specified ^1'pid' ^2with reason ^1'optional_reason'.
 ^1!unreport ip_address optional_reason ^5-> ^3removes previously reported player whose ^1IP address is ^1'ip_address'.
 ^1!reports optional_number ^5-> ^3displays ^1all ^3or last ^1'optional_number' ^3reported players.
 ^1!tp [optional_number] ^5-> displays top ^125 ^3or ^1optional_number ^3players' stats data.
 ^1!tpd [optional_number] ^5-> displays top ^125 ^5or ^1optional_number ^5players' stats data for current day.
 ...
 ^1tell player_pid "private message" ^3-> Sends "private message" to player whose pid = player_pid
		...
		print_colored_text(app_handles.hwnd_re_messages_data, help_message.c_str(), is_append_message_to_richedit_control::yes, is_log_message::no, is_log_datetime::no);
	...
	const string &arg)
{
	// print_trace_message(__FILE__, __LINE__, __FUNCTION__);
	int number{};
	if ((str_compare_i(cmd, "!r") == 0) || (str_compare_i(cmd, "!report") == 0) || (str_compare_i(cmd, "!w") == 0) || (str_compare_i(cmd, "!warn") == 0) || (str_compare_i(cmd, "!k") == 0) || (str_compare_i(cmd, "!kick") == 0) || (str_compare_i(cmd, "clientkick") == 0) || (str_compare_i(cmd, "tempbanclient") == 0) || (str_compare_i(cmd, "!b") == 0) || (str_compare_i(cmd, "!ban") == 0) || (str_compare_i(cmd, "banclient") == 0))
	{
...
void remove_all_color_codes(wchar_t *msg)
{
	...
	while (start < msg_len)
	{
		...
		if (start + 4 <= msg_len && msg[start + 1] == L'^' && (msg[start + 2] >= L'0' && msg[start + 2] <= L'9') && (msg[start + 3] >= L'0' && msg[start + 3] <= L'9') /*&& msg[start + 2] == msg[start + 3]*/)
		{
			stl::helper::str_erase_n_chars(msg, start, 4);
		}
...
void remove_all_color_codes(std::wstring &msg)
{
	...
	while (start < msg.length())
	{
		...
		if (start + 4 <= msg.length() && msg[start + 1] == L'^' && (msg[start + 2] >= L'0' && msg[start + 2] <= L'9') && (msg[start + 3] >= L'0' && msg[start + 3] <= L'9') /*&& msg[start + 2] == msg[start + 3]*/)
		{
			msg.erase(start, 4);
		}
						...
						online_player.ip_address, &pd))
				{
					...
					if (ban_expires_time > now_in_seconds)
					{
						...
						else
						{
							...
							main_app.get_tinyrcon_dict()["{BANNED_BY}"] = remove_disallowed_character_in_string(
...
void check_for_banned_ip_addresses()
{
	...
	for (size_t i{}; i < main_app.get_current_game_server().get_number_of_players(); ++i)
	{
		...
		{
			const bool is_short_ip_address_range_ban{
				banned_ip_address_ranges.contains(narrow_ip_address_range) && !is_ip_range_protected && !is_city_protected && !is_country_protected};
			const bool is_wider_ip_address_range_ban{
				banned_ip_address_ranges.contains(wide_ip_address_range) && !is_ip_range_protected && !is_city_protected && !is_country_protected};
			...
			if (is_short_ip_address_range_ban || is_wider_ip_address_range_ban)
			{
				...
				const string banned_player_information{get_player_information(online_player.pid)};
				const string private_message{
					format("^1Automatic kick ^5for player with an ^1IP address ^5from a previously ^1banned IP address range: {}\n ^5| Reason: ^1{}\n{}\n",
						   (is_short_ip_address_range_ban ? narrow_ip_address_range : wide_ip_address_range),
						   pd.reason,
						   banned_player_information)};
				replace_br_with_new_line(public_message);
				print_colored_text(app_handles.hwnd_re_messages_data, private_message.c_str(), is_append_message_to_richedit_control::yes, is_log_message::yes, is_log_datetime::yes);
		...
		if (!banned_player_names.empty())
		{
			...
			if (banned_player_names.contains(player_name))
			{
				...
				const string banned_player_information{get_player_information(online_player.pid)};
				const string msg{
					format("^1Automatic kick ^5for previously ^3banned player name: ^1{} ^5| ^3Reason: ^1{}\n{}\n",
						   player_name,
...
bool check_if_player_is_protected(const player &online_player, const char *admin_command, string &message)
{
	...
	if (check_ip_address_validity(online_player.ip_address, guid))
	{
		...
		const string wide_ip_address_range{
			get_wide_ip_address_range_for_specified_ip_address(online_player.ip_address)};
		is_ip_protected = main_app.get_current_game_server().get_protected_ip_addresses().contains(
			online_player.ip_address);
		is_ip_range_protected = main_app.get_current_game_server().get_protected_ip_address_ranges().contains(
									narrow_ip_address_range) ||
								main_app.get_current_game_server().get_protected_ip_address_ranges().contains(
									wide_ip_address_range);

		if (is_ip_protected)
		{
			message.assign(
				format("^3Discarded ^1{} ^3on player ^7{} ^3whose IP address ^1{} ^3is protected!\n^5Please, remove their ^1protected IP address ^5first.",
					   admin_command,
					   online_player.player_name,
					   online_player.ip_address));
			return true;
		...
		{
			message.assign(
				format("^3Discarded ^1{} ^3on player ^7{} ^3whose IP address range ^1{} ^3is protected!\n^5Please, remove their ^1protected IP address range ^5first.",
					   admin_command,
					   online_player.player_name,
					   main_app.get_current_game_server().get_protected_ip_address_ranges().contains(
						   narrow_ip_address_range)
	...
	{
		message.assign(
			format("^3Discarded ^1{} ^3on player ^7{} ^3whose city ^1{} ^3is protected!\n^5Please, remove their ^1protected city ^5first.",
				   admin_command,
				   online_player.player_name,
				   online_player.city));
		return true;
	...
	if (is_country_protected)
	{
		...
		message.assign(
			format("^3Discarded ^1{} ^3on player ^7{} ^3whose country ^1{} ^3is protected!\n^5Please, remove their ^1protected country ^5first.",
				   admin_command,
				   online_player.player_name,
				   online_player.country_name));
		return true;
...
void rcon_say(string &msg, const bool is_print_to_rich_edit_messages_box)
{
	...
	for (const auto &line : lines)
	{
		...
		{
			print_colored_text(app_handles.hwnd_re_messages_data, line.c_str(), is_append_message_to_richedit_control::yes, is_log_message::yes, is_log_datetime::yes, true, true);
		}
	}
}
...
void tell_message(const char *message, const int pid)
{
	...
	for (const auto &line : lines)
	{
		// main_app.add_command_to_queue({ "tell", to_string(pid), format("\"{}\"", line) }, command_type::rcon, false);
...
void sort_players_data(std::vector<player> &players_data, const sort_type sort_method)
{
	...
	/*if (sort_method == sort_type::geo_asc || sort_method == sort_type::geo_desc && (players_data[0].country_name == nullptr || len(players_data[0].country_name) == 0 || strcmp(players_data[0].country_name, "Unknown") == 0)) {
	sort_method = sort_type::score_desc;
  }*/
	switch (sort_method)
	{
											 ...
											 const bool is_save_data_to_log_file)
{
	...
	const size_t number_of_entries_to_display{number_of_last_bans_to_display != string::npos && number_of_last_bans_to_display < temp_banned_players.size()
	...
	if (temp_banned_players.empty())
	{
		const size_t message_len = stl::helper::len(
			"| There are no players temporarily banned by their IP addresses yet.");
	...
	else
	{
		...
		for (size_t i{start_index}; i < temp_banned_players.size(); ++i)
		{
			...
			const string ban_start_date_str = get_date_and_time_for_time_t("{DD}.{MM}.{Y} {hh}:{mm}",
																		   bp.banned_start_time);
			const string ban_expires_date_str = get_time_interval_info_string_for_seconds(
				remaining_tempban_duration_in_seconds);
			oss << next_color << left << setw(longest_country_length) << buffer2 << " ^5| " << next_color << left
				<< setw(20) << ban_start_date_str
...
void display_banned_ip_address_ranges(const size_t number_of_last_bans_to_display, const bool is_save_data_to_log_file)
{
	...
	const size_t number_of_entries_to_display{
		number_of_last_bans_to_display != string::npos && number_of_last_bans_to_display < banned_players.size()
			? number_of_last_bans_to_display
			: banned_players.size()};
...
void display_protected_entries(const char *table_title, const std::set<std::string> &protected_entries, const unordered_map<string, string> &online_player_names, const bool is_save_data_to_log_file)
{
	...
	if (!banned_players.empty())
	{
		longest_protected_entry_length = std::max(longest_protected_entry_length,
												  find_longest_entry_length(cbegin(protected_entries),
																			cend(protected_entries),
																			false));
	}
...
void display_reported_players(const size_t number_of_last_reports_to_display, const bool is_save_data_to_log_file)
{
	...
	const size_t number_of_entries_to_display{number_of_last_reports_to_display != string::npos && number_of_last_reports_to_display < reported_players.size()
	...
	else
	{
		...
		const size_t start_index{
			number_of_entries_to_display != string::npos && number_of_entries_to_display <= reported_players.size()
...
void display_all_available_maps()
{
	...
	print_colored_text(app_handles.hwnd_re_messages_data, oss.str().c_str(), is_append_message_to_richedit_control::yes, is_log_message::yes, is_log_datetime::yes, false, true);
}
...
void change_colors()
{
	...
	{
		print_colored_text(app_handles.hwnd_re_messages_data,
						   "^3Use different alternating background colors for even and odd lines? (yes|no, enter for default (yes): ",
						   is_append_message_to_richedit_control::yes,
						   is_log_message::no);
		getline(cin, color_code);
	...
	if (main_app.get_is_use_different_background_colors_for_even_and_odd_lines())
	{
		...
		{
			print_colored_text(app_handles.hwnd_re_messages_data,
							   "^5Background color of odd player data lines (0-9), press enter to accept default (0 - black): ",
							   is_append_message_to_richedit_control::yes,
							   is_log_message::no);
			getline(cin, color_code);
		} while (!color_code.empty() && !regex_match(color_code, color_code_regex));
		...
		{
			print_colored_text(app_handles.hwnd_re_messages_data,
							   "^3Background color of even player data lines (0-9), press enter to accept default (8 - gray): ",
							   is_append_message_to_richedit_control::yes,
							   is_log_message::no);
			getline(cin, color_code);
		} while (!color_code.empty() && !regex_match(color_code, color_code_regex));
	...
	{
		print_colored_text(app_handles.hwnd_re_messages_data,
						   "^5Use different alternating foreground colors for even and odd lines? (yes|no, enter for default (yes): ",
						   is_append_message_to_richedit_control::yes,
						   is_log_message::no);
		getline(cin, color_code);
		stl::helper::to_lower_case_in_place(color_code);
	...
	if (main_app.get_is_use_different_foreground_colors_for_even_and_odd_lines())
	{
		...
		{
			print_colored_text(app_handles.hwnd_re_messages_data,
							   "Foreground color of odd player data lines (0-9), press enter to accept default (5): ",
							   is_append_message_to_richedit_control::yes,
							   is_log_message::no);
			getline(cin, color_code);
		} while (!color_code.empty() && !regex_match(color_code, color_code_regex));
		...
		{
			print_colored_text(app_handles.hwnd_re_messages_data,
							   "Foreground color of even player data lines (0-9), press enter to accept default (3): ",
							   is_append_message_to_richedit_control::yes,
							   is_log_message::no);
			getline(cin, color_code);
		} while (!color_code.empty() && !regex_match(color_code, color_code_regex));
 ...
 ^1!config name ^5new_user_name (for example: ^1config name Admin)
	...
	if (command[0] == "!config")
	{
		...
		if (command[1] == "rcon")
		{
			...
			{
				print_colored_text(app_handles.hwnd_re_messages_data,
								   "^3The provided ^1rcon password ^3is too short or it is the same as\n the currently used ^1rcon password^3!\n",
								   is_append_message_to_richedit_control::yes,
								   is_log_message::yes,
								   is_log_datetime::yes);
				return false;
			...
			const string re_msg{
				"^2You have successfully changed the ^1rcon password ^2to \"^5"s + command[2] + "^2\"\n"s};
			print_colored_text(app_handles.hwnd_re_messages_data, re_msg.c_str(), is_append_message_to_richedit_control::yes, is_log_message::yes, is_log_datetime::yes);
		...
		else if (command[1] == "private")
		{
			...
			{
				print_colored_text(app_handles.hwnd_re_messages_data,
								   "^3The provided ^1private password ^3is too short or it is the same\n as the currently used ^1private password^3!\n",
								   is_append_message_to_richedit_control::yes,
								   is_log_message::yes,
								   is_log_datetime::yes);
				return false;
	...
	for (size_t i{}; i < main_app.get_current_game_server().get_number_of_players(); ++i)
	{
		if (pid == players_data[i].pid)
		{
			...
			if (main_app.get_current_game_server().get_banned_ip_addresses_map().contains(p.ip_address) || main_app.get_current_game_server().get_temp_banned_ip_addresses_map().contains(p.ip_address) || !p.banned_by_user_name.empty())
			{
				...
				{
					result += format(" ^3Banned by admin: ^7{}",
				...
				{
					result += format(" ^3Banned by admin: ^7{}",
									 main_app.get_current_game_server().get_temp_banned_ip_addresses_map()[p.ip_address].banned_by_user_name);
				}
				else
				{
...
std::string get_player_information_for_player(player &p)
{
	...
	if (main_app.get_current_game_server().get_banned_ip_addresses_map().contains(p.ip_address) || main_app.get_current_game_server().get_temp_banned_ip_addresses_map().contains(p.ip_address) || !p.banned_by_user_name.empty())
	{
		if (main_app.get_current_game_server().get_banned_ip_addresses_map().contains(p.ip_address))
		{
			result += format(" ^5| ^3Banned by admin: ^7{}",
							 main_app.get_current_game_server().get_banned_ip_addresses_map()[p.ip_address].banned_by_user_name);
		}
			...
			if (status == ERROR_SUCCESS)
			{
				...
				if (status == ERROR_SUCCESS)
				{
					...
					if (check_if_file_path_exists(steam_exe_path.c_str()))
					{
						...
						string cod5mp_path2{steam_exe_path.substr(0, steam_exe_path.rfind(L'\\')) + "\\steamapps\\common\\Call of Duty(R) World at War\\cod5mp.exe"s};
	...
	if (EnumProcesses(processes, sizeof(processes), &processes_size))
		for (size_t i{}; i < processes_size; ++i)
		{
			...
			if (n != 0)
			{
				...
				if (module_base_name.find(L"Call of Duty 2") != wstring::npos || module_base_name.find(L"Call of Duty(R) 2") != wstring::npos || stl::helper::str_index_of(module_base_name, L"cod2mp_s.exe", true) != wstring::npos)
				{
					GetModuleFileNameExW(ph, nullptr, buffer, (DWORD)std::size(buffer));
					module_base_name.assign(buffer);
					const auto start = stl::helper::str_last_index_of(module_base_name, L"cod2mp_s.exe", string::npos, true);
...
size_t print_message(HWND re_control,
...
CHARFORMATA get_char_fmt(HWND hwnd, DWORD range)
{
	// // print_trace_message(__FILE__, __LINE__, __FUNCTION__);
	CHARFORMATA cf;
...
void construct_tinyrcon_gui(HWND hWnd)
{
	...
	app_handles.hwnd_online_admins_information = CreateWindowExA(0, RICHEDIT_CLASSA, nullptr, WS_VISIBLE | WS_CHILD | ES_LEFT | ES_READONLY, 10, 13, screen_width / 2 + 150, 25, hWnd, nullptr, app_handles.hInstance, nullptr);
	...
	app_handles.hwnd_match_information = CreateWindowExA(0, RICHEDIT_CLASSA, nullptr, WS_VISIBLE | WS_CHILD | ES_LEFT | ES_READONLY, 10, 50, screen_width / 2 + 150, 30, hWnd, nullptr, app_handles.hInstance, nullptr);
	...
	app_handles.hwnd_re_messages_data = CreateWindowExA(0, RICHEDIT_CLASSA, nullptr, WS_BORDER | WS_VISIBLE | WS_CHILD | WS_VSCROLL | WS_HSCROLL | ES_MULTILINE | ES_LEFT /*| ES_AUTOVSCROLL*/ | ES_NOHIDESEL | ES_READONLY, screen_width / 2 + 170, 80, screen_width / 2 - 190, screen_height / 2 - 120, hWnd, reinterpret_cast<HMENU>(ID_BANNEDEDIT), app_handles.hInstance, nullptr);
	...
	app_handles.hwnd_re_help_data = CreateWindowExA(0, RICHEDIT_CLASSA, nullptr, WS_BORDER | WS_VISIBLE | WS_CHILD | WS_VSCROLL | WS_HSCROLL | ES_MULTILINE | ES_LEFT | ES_AUTOVSCROLL | ES_READONLY, screen_width / 2 + 170, screen_height / 2, screen_width - 20 - (screen_width / 2 + 170), screen_height - 120 - (screen_height / 2 + 100), hWnd, nullptr, app_handles.hInstance, nullptr);
	...
	app_handles.hwnd_e_user_input = CreateWindowExA(0, "Edit", nullptr, WS_GROUP | WS_TABSTOP | WS_CHILD | WS_VISIBLE | WS_BORDER | ES_LEFT | ES_AUTOHSCROLL, 125, screen_height - 70, 305, 20, hWnd, reinterpret_cast<HMENU>(ID_USEREDIT), app_handles.hInstance, nullptr);

	app_handles.hwnd_button_warn = CreateWindowExA(NULL, "Button", "&Warn", WS_GROUP | WS_TABSTOP | BS_PUSHBUTTON | BS_CENTER | BS_VCENTER | WS_VISIBLE | WS_CHILD, 10, screen_height - 118, 80, 30, hWnd, reinterpret_cast<HMENU>(ID_WARNBUTTON), app_handles.hInstance, nullptr);

	app_handles.hwnd_button_kick = CreateWindowExA(NULL, "Button", "&Kick", BS_PUSHBUTTON | BS_CENTER | BS_VCENTER | WS_VISIBLE | WS_CHILD, 110, screen_height - 118, 80, 30, hWnd, reinterpret_cast<HMENU>(ID_KICKBUTTON), app_handles.hInstance, nullptr);

	app_handles.hwnd_button_tempban = CreateWindowExA(NULL, "Button", "&Tempban", BS_PUSHBUTTON | BS_CENTER | BS_VCENTER | WS_VISIBLE | WS_CHILD, 210, screen_height - 118, 100, 30, hWnd, reinterpret_cast<HMENU>(ID_TEMPBANBUTTON), app_handles.hInstance, nullptr);

	app_handles.hwnd_button_ipban = CreateWindowExA(NULL, "Button", "Ban &IP", BS_PUSHBUTTON | BS_CENTER | BS_VCENTER | WS_VISIBLE | WS_CHILD, 330, screen_height - 118, 100, 30, hWnd, reinterpret_cast<HMENU>(ID_IPBANBUTTON), app_handles.hInstance, nullptr);

	app_handles.hwnd_button_view_tempbans = CreateWindowExA(NULL, "Button", "View temporary bans", BS_PUSHBUTTON | BS_CENTER | BS_VCENTER | WS_VISIBLE | WS_CHILD, 450, screen_height - 118, 180, 30, hWnd, reinterpret_cast<HMENU>(ID_VIEWTEMPBANSBUTTON), app_handles.hInstance, nullptr);

	app_handles.hwnd_button_view_ipbans = CreateWindowExA(NULL, "Button", "View IP bans", BS_PUSHBUTTON | BS_CENTER | BS_VCENTER | WS_VISIBLE | WS_CHILD, 650, screen_height - 118, 140, 30, hWnd, reinterpret_cast<HMENU>(ID_VIEWIPBANSBUTTON), app_handles.hInstance, nullptr);

	app_handles.hwnd_button_view_adminsdata = CreateWindowExA(NULL, "Button", "View admins' data", BS_PUSHBUTTON | BS_CENTER | BS_VCENTER | WS_VISIBLE | WS_CHILD, screen_width / 2 + 170, screen_height - 175, 150, 25, hWnd, reinterpret_cast<HMENU>(ID_VIEWADMINSDATA), app_handles.hInstance, nullptr);

	app_handles.hwnd_connect_button = CreateWindowExA(NULL, "Button", "Join server", BS_PUSHBUTTON | BS_CENTER | BS_VCENTER | WS_VISIBLE | WS_CHILD, 450, screen_height - 77, 180, 30, hWnd, reinterpret_cast<HMENU>(ID_CONNECTBUTTON), app_handles.hInstance, nullptr);
	...
	app_handles.hwnd_say_button = CreateWindowExA(NULL, "Button", "Send public message", BS_PUSHBUTTON | BS_CENTER | BS_VCENTER | WS_VISIBLE | WS_CHILD, screen_width / 2 + 170, screen_height - 140, 150, 25, hWnd, reinterpret_cast<HMENU>(ID_SAY_BUTTON), app_handles.hInstance, nullptr);

	app_handles.hwnd_tell_button = CreateWindowExA(NULL, "Button", "Send private message", BS_PUSHBUTTON | BS_CENTER | BS_VCENTER | WS_VISIBLE | WS_CHILD, screen_width / 2 + 170, screen_height - 105, 150, 25, hWnd, reinterpret_cast<HMENU>(ID_TELL_BUTTON), app_handles.hInstance, nullptr);

	app_handles.hwnd_quit_button = CreateWindowExA(NULL, "Button", "E&xit", BS_PUSHBUTTON | BS_CENTER | BS_VCENTER | WS_VISIBLE | WS_CHILD, screen_width - 90, screen_height - 90, 70, 28, hWnd, reinterpret_cast<HMENU>(ID_QUITBUTTON), app_handles.hInstance, nullptr);

	app_handles.hwnd_clear_messages_button = CreateWindowExA(NULL, "Button", "C&lear messages", BS_PUSHBUTTON | BS_CENTER | BS_VCENTER | WS_VISIBLE | WS_CHILD, screen_width / 2 + 170, 8, 120, 28, hWnd, reinterpret_cast<HMENU>(ID_CLEARMESSAGESCREENBUTTON), app_handles.hInstance, nullptr);

	app_handles.hwnd_configure_server_settings_button = CreateWindowExA(NULL, "Button", "Configure settings", BS_PUSHBUTTON | BS_CENTER | BS_VCENTER | WS_VISIBLE | WS_CHILD, screen_width / 2 + 310, 8, 130, 28, hWnd, reinterpret_cast<HMENU>(ID_BUTTON_CONFIGURE_SERVER_SETTINGS), app_handles.hInstance, nullptr);

	app_handles.hwnd_button_view_rcon = CreateWindowExA(NULL, "Button", "&Switch to rcon view", BS_PUSHBUTTON | BS_CENTER | BS_VCENTER | WS_VISIBLE | WS_CHILD, screen_width / 2 + 460, 8, 140, 28, hWnd, reinterpret_cast<HMENU>(ID_RCONVIEWBUTTON), app_handles.hInstance, nullptr);

	app_handles.hwnd_button_players_view = CreateWindowExA(NULL, "Button", "Show players", BS_PUSHBUTTON | BS_CENTER | BS_VCENTER | WS_VISIBLE | WS_CHILD, screen_width / 2 + 170, 45, 120, 28, hWnd, reinterpret_cast<HMENU>(ID_SHOWPLAYERSBUTTON), app_handles.hInstance, nullptr);

	app_handles.hwnd_refresh_players_data_button = CreateWindowExA(NULL, "Button", "&Refresh players", BS_PUSHBUTTON | BS_CENTER | BS_VCENTER | WS_VISIBLE | WS_CHILD, screen_width / 2 + 310, 45, 130, 28, hWnd, reinterpret_cast<HMENU>(ID_REFRESH_PLAYERS_DATA_BUTTON), app_handles.hInstance, nullptr);

	app_handles.hwnd_button_game_servers_list_view = CreateWindowExA(NULL, "Button", "Show servers", BS_PUSHBUTTON | BS_CENTER | BS_VCENTER | WS_VISIBLE | WS_CHILD, screen_width / 2 + 460, 45, 140, 28, hWnd, reinterpret_cast<HMENU>(ID_SHOWSERVERSBUTTON), app_handles.hInstance, nullptr);

	/*app_handles.hwnd_button_refresh_game_servers = CreateWindowExA(NULL, "Button", "Refresh servers", BS_PUSHBUTTON | BS_CENTER | BS_VCENTER | WS_VISIBLE | WS_CHILD, screen_width / 2 + 620, 45, 120, 28, hWnd, reinterpret_cast<HMENU>(ID_REFRESHSERVERSBUTTON), app_handles.hInstance, nullptr);*/

	app_handles.hwnd_combo_box_sortmode = CreateWindowExA(NULL, "Combobox", nullptr, WS_GROUP | WS_CHILD | WS_VISIBLE | CBS_DROPDOWNLIST | WS_VSCROLL | WS_HSCROLL, screen_width - 470, screen_height - 210, 260, 210, hWnd, reinterpret_cast<HMENU>(ID_COMBOBOX_SORTMODE), app_handles.hInstance, nullptr);

	SetWindowSubclass(app_handles.hwnd_combo_box_sortmode, ComboProc, 0, 0);

	app_handles.hwnd_combo_box_map = CreateWindowExA(NULL, "Combobox", nullptr, WS_CHILD | WS_VISIBLE | CBS_DROPDOWNLIST | CBS_SORT | WS_VSCROLL | WS_HSCROLL, screen_width / 2 + 210, screen_height / 2 - 30, 150, 200, hWnd, reinterpret_cast<HMENU>(ID_COMBOBOX_MAP), app_handles.hInstance, nullptr);

	SetWindowSubclass(app_handles.hwnd_combo_box_map, ComboProc, 0, 0);

	app_handles.hwnd_combo_box_gametype = CreateWindowExA(NULL, "Combobox", nullptr, WS_CHILD | WS_VISIBLE | CBS_DROPDOWNLIST | CBS_SORT | WS_VSCROLL | WS_HSCROLL, screen_width / 2 + 460, screen_height / 2 - 30, 60, 130, hWnd, reinterpret_cast<HMENU>(ID_COMBOBOX_GAMETYPE), app_handles.hInstance, nullptr);

	SetWindowSubclass(app_handles.hwnd_combo_box_gametype, ComboProc, 0, 0);

	app_handles.hwnd_button_load = CreateWindowExA(NULL, "Button", "Load map", BS_PUSHBUTTON | BS_CENTER | BS_VCENTER | WS_VISIBLE | WS_CHILD, screen_width / 2 + 540, screen_height / 2 - 33, 80, 25, hWnd, reinterpret_cast<HMENU>(ID_LOADBUTTON), app_handles.hInstance, nullptr);
...
void display_players_data_in_players_grid(HWND hgrid)
{
	...
	SimpleGrid_SetColWidth(hgrid,
						   5,
						   players_grid_width - (player_name_column_width + 420));
	SimpleGrid_SetColWidth(hgrid,
						   6,
						   50);
...
void display_game_servers_data_in_servers_grid(HWND
												   hgrid)
{
	// print_trace_message(__FILE__, __LINE__, __FUNCTION__);
	...
	SimpleGrid_SetColWidth(hgrid,
						   4,
						   servers_grid_width - (server_name_column_width + 510));
	SimpleGrid_SetColWidth(hgrid,
						   5,
						   50);
	SimpleGrid_SetColWidth(hgrid,
...
void initialize_servers_grid(HWND
								 hgrid,
							 const size_t cols,
							 const size_t rows)
{
...
bool show_user_confirmation_dialog(const char *msg, const char *title, const char *)
{
	...
	app_handles.hwnd_confirmation_dialog = CreateWindowEx(WS_EX_OVERLAPPEDWINDOW,
														  ...
														  600,
														  320,
														  app_handles.hwnd_main_window,
														  nullptr,
														  app_handles.hInstance,
														  nullptr);
	...
	app_handles.hwnd_re_confirmation_message = CreateWindowExA(0, RICHEDIT_CLASSA, nullptr, WS_BORDER | WS_VISIBLE | WS_CHILD | WS_VSCROLL | ES_MULTILINE | ES_LEFT | ES_AUTOVSCROLL | ES_READONLY, 10, 10, 560, 200, app_handles.hwnd_confirmation_dialog, nullptr, app_handles.hInstance, nullptr);
	if (!app_handles.hwnd_re_confirmation_message)
		return false;
	...
	app_handles.hwnd_e_reason = CreateWindowExA(0, "Edit", nullptr, WS_CHILD | WS_VISIBLE | WS_BORDER | ES_LEFT, 100, 220, 470, 20, app_handles.hwnd_confirmation_dialog, reinterpret_cast<HMENU>(ID_EDIT_ADMIN_REASON), app_handles.hInstance, nullptr);

	if (app_handles.hwnd_yes_button)
	{
		DestroyWindow(app_handles.hwnd_yes_button);
	}
	app_handles.hwnd_yes_button = CreateWindowExA(NULL, "Button", "Yes", BS_PUSHBUTTON | BS_CENTER | BS_VCENTER | WS_VISIBLE | WS_CHILD, 100, 250, 50, 20, app_handles.hwnd_confirmation_dialog, reinterpret_cast<HMENU>(ID_YES_BUTTON), app_handles.hInstance, nullptr);

	if (app_handles.hwnd_no_button)
	{
		DestroyWindow(app_handles.hwnd_no_button);
	}
	app_handles.hwnd_no_button = CreateWindowExA(NULL, "Button", "No", BS_PUSHBUTTON | BS_CENTER | BS_VCENTER | WS_VISIBLE | WS_CHILD, 170, 250, 50, 20, app_handles.hwnd_confirmation_dialog, reinterpret_cast<HMENU>(ID_NO_BUTTON), app_handles.hInstance, nullptr);
...
void process_sort_type_change_request(const sort_type new_sort_type)
{
	...
	case sort_type::pid_desc:
		print_colored_text(app_handles.hwnd_re_messages_data,
						   "^2Executing ^1!sort pid desc ^2command and refreshing players data.\n");
		break;
	case sort_type::score_asc:
		print_colored_text(app_handles.hwnd_re_messages_data,
						   "^2Executing ^1!sort score asc ^2command and refreshing players data.\n");
		break;
	case sort_type::score_desc:
		print_colored_text(app_handles.hwnd_re_messages_data,
						   "^2Executing ^1!sort score desc ^2command and refreshing players data.\n");
		break;
	case sort_type::ping_asc:
		print_colored_text(app_handles.hwnd_re_messages_data,
						   "^2Executing ^1!sort ping asc ^2command and refreshing players data.\n");
		break;
	case sort_type::ping_desc:
		print_colored_text(app_handles.hwnd_re_messages_data,
						   "^2Executing ^1!sort ping desc ^2command and refreshing players data.\n");
		break;
	case sort_type::name_asc:
		print_colored_text(app_handles.hwnd_re_messages_data,
						   "^2Executing ^1!sort name asc ^2command and refreshing players data.\n");
		break;
	case sort_type::name_desc:
		print_colored_text(app_handles.hwnd_re_messages_data,
						   "^2Executing ^1!sort name desc ^2command and refreshing players data.\n");
		break;
	case sort_type::ip_asc:
		print_colored_text(app_handles.hwnd_re_messages_data,
	...
	case sort_type::geo_desc:
		print_colored_text(app_handles.hwnd_re_messages_data,
						   "^2Executing ^1!sort geo desc ^2command and refreshing players data.\n");
		break;
	}
...
bool show_and_process_tinyrcon_configuration_panel(const char *title)
{
	...
	(void)CreateWindowExA(0, "Static", "Admin name:", WS_CHILD | WS_VISIBLE | SS_LEFT, 10, 10, 120, 20, app_handles.hwnd_configuration_dialog, nullptr, app_handles.hInstance, nullptr);
	...
	app_handles.hwnd_user_name = CreateWindowExA(0, "Edit", nullptr, WS_CHILD | WS_VISIBLE | WS_BORDER | ES_LEFT, 220, 10, 450, 20, app_handles.hwnd_configuration_dialog, (HMENU)ID_EDIT_ADMIN_NAME, app_handles.hInstance, nullptr);
	if (!app_handles.hwnd_user_name)
		return false;

	(void)CreateWindowExA(0, "Static", "Server name:", WS_CHILD | WS_VISIBLE | SS_LEFT, 10, 40, 120, 20, app_handles.hwnd_configuration_dialog, nullptr, app_handles.hInstance, nullptr);
	...
	app_handles.hwnd_server_name = CreateWindowExA(0, "Edit", nullptr, WS_CHILD | WS_VISIBLE | WS_BORDER | ES_LEFT, 220, 40, 450, 20, app_handles.hwnd_configuration_dialog, (HMENU)ID_EDIT_SERVER_NAME, app_handles.hInstance, nullptr);
	if (!app_handles.hwnd_server_name)
		return false;
	...
	(void)CreateWindowExA(0, "Static", "Server IP address:", WS_CHILD | WS_VISIBLE | SS_LEFT, 10, 70, 130, 20, app_handles.hwnd_configuration_dialog, nullptr, app_handles.hInstance, nullptr);

	app_handles.hwnd_server_ip_address = CreateWindowExA(0, "Edit", nullptr, WS_CHILD | WS_VISIBLE | WS_BORDER | ES_LEFT, 220, 70, 450, 20, app_handles.hwnd_configuration_dialog, (HMENU)ID_EDIT_SERVER_IP, app_handles.hInstance, nullptr);
	...
	(void)CreateWindowExA(0, "Static", "Server port:", WS_CHILD | WS_VISIBLE | SS_LEFT, 10, 100, 120, 20, app_handles.hwnd_configuration_dialog, nullptr, app_handles.hInstance, nullptr);

	app_handles.hwnd_server_port = CreateWindowExA(0, "Edit", nullptr, WS_CHILD | WS_VISIBLE | WS_BORDER | ES_LEFT, 220, 100, 450, 20, app_handles.hwnd_configuration_dialog, (HMENU)ID_EDIT_SERVER_PORT, app_handles.hInstance, nullptr);
	...
	(void)CreateWindowExA(0, "Static", "Rcon password:", WS_CHILD | WS_VISIBLE | SS_LEFT, 10, 130, 140, 20, app_handles.hwnd_configuration_dialog, nullptr, app_handles.hInstance, nullptr);

	app_handles.hwnd_rcon_password = CreateWindowExA(0, "Edit", nullptr, WS_CHILD | WS_VISIBLE | WS_BORDER | ES_LEFT, 220, 130, 450, 20, app_handles.hwnd_configuration_dialog, (HMENU)ID_EDIT_SERVER_RCON, app_handles.hInstance, nullptr);
	...
	(void)CreateWindowExA(0, "Static", "Enable city ban feature:", WS_CHILD | WS_VISIBLE | SS_LEFT, 10, 160, 180, 20, app_handles.hwnd_configuration_dialog, nullptr, app_handles.hInstance, nullptr);

	app_handles.hwnd_enable_city_ban = CreateWindowExA(WS_EX_TRANSPARENT, "BUTTON", nullptr, WS_VISIBLE | WS_CHILD | BS_CHECKBOX, 210, 160, 15, 20, app_handles.hwnd_configuration_dialog, (HMENU)ID_ENABLE_CITY_BAN_CHECKBOX, app_handles.hInstance, nullptr);

	if (!app_handles.hwnd_enable_city_ban)
		return false;

	(void)CreateWindowExA(0, "Static", "Enable country ban feature:", WS_CHILD | WS_VISIBLE | SS_LEFT, 260, 160, 180, 20, app_handles.hwnd_configuration_dialog, nullptr, app_handles.hInstance, nullptr);

	app_handles.hwnd_enable_country_ban = CreateWindowExA(WS_EX_TRANSPARENT, "BUTTON", nullptr, WS_VISIBLE | WS_CHILD | BS_CHECKBOX, 480, 160, 15, 20, app_handles.hwnd_configuration_dialog, (HMENU)ID_ENABLE_COUNTRY_BAN_CHECKBOX, app_handles.hInstance, nullptr);
	...
	(void)CreateWindowExA(0, "Static", "Call of Duty installation path:", WS_CHILD | WS_VISIBLE | SS_LEFT, 10, 195, 200, 25, app_handles.hwnd_configuration_dialog, nullptr, app_handles.hInstance, nullptr);

	app_handles.hwnd_cod1_path_edit = CreateWindowExA(0, "Edit", nullptr, WS_CHILD | WS_VISIBLE | WS_BORDER | ES_LEFT | ES_MULTILINE | ES_AUTOHSCROLL | WS_HSCROLL, 220, 190, 450, 40, app_handles.hwnd_configuration_dialog, (HMENU)ID_EDIT_CONFIGURATION_COD1_PATH, app_handles.hInstance, nullptr);
	...
	app_handles.hwnd_cod1_path_button = CreateWindowExA(NULL, "Button", "Browse for codmp.exe", BS_PUSHBUTTON | BS_CENTER | BS_VCENTER | WS_VISIBLE | WS_CHILD, 680, 200, 190, 25, app_handles.hwnd_configuration_dialog, (HMENU)ID_BUTTON_CONFIGURATION_COD1_PATH, app_handles.hInstance, nullptr);
	if (!app_handles.hwnd_cod1_path_button)
		return false;
	...
	(void)CreateWindowExA(0, "Static", "Call of Duty 2 installation path:", WS_CHILD | WS_VISIBLE | SS_LEFT, 10, 245, 200, 25, app_handles.hwnd_configuration_dialog, nullptr, app_handles.hInstance, nullptr);

	app_handles.hwnd_cod2_path_edit = CreateWindowExA(0, "Edit", nullptr, WS_CHILD | WS_VISIBLE | WS_BORDER | ES_LEFT | ES_MULTILINE | ES_AUTOHSCROLL | WS_HSCROLL, 220, 240, 450, 40, app_handles.hwnd_configuration_dialog, (HMENU)ID_EDIT_CONFIGURATION_COD2_PATH, app_handles.hInstance, nullptr);
	...
	app_handles.hwnd_cod2_path_button = CreateWindowExA(NULL, "Button", "Browse for cod2mp_s.exe", BS_PUSHBUTTON | BS_CENTER | BS_VCENTER | WS_VISIBLE | WS_CHILD, 680, 250, 190, 25, app_handles.hwnd_configuration_dialog, (HMENU)ID_BUTTON_CONFIGURATION_COD2_PATH, app_handles.hInstance, nullptr);
	if (!app_handles.hwnd_cod2_path_button)
		return false;
	...
	(void)CreateWindowExA(0, "Static", "Call of Duty 4 installation path:", WS_CHILD | WS_VISIBLE | SS_LEFT, 10, 295, 200, 25, app_handles.hwnd_configuration_dialog, nullptr, app_handles.hInstance, nullptr);

	app_handles.hwnd_cod4_path_edit = CreateWindowExA(0, "Edit", nullptr, WS_CHILD | WS_VISIBLE | WS_BORDER | ES_LEFT | ES_MULTILINE | ES_AUTOHSCROLL | WS_HSCROLL, 220, 290, 450, 40, app_handles.hwnd_configuration_dialog, (HMENU)ID_EDIT_CONFIGURATION_COD4_PATH, app_handles.hInstance, nullptr);
	...
	app_handles.hwnd_cod4_path_button = CreateWindowExA(NULL, "Button", "Browse for iw3mp.exe", BS_PUSHBUTTON | BS_CENTER | BS_VCENTER | WS_VISIBLE | WS_CHILD, 680, 300, 190, 25, app_handles.hwnd_configuration_dialog, (HMENU)ID_BUTTON_CONFIGURATION_COD4_PATH, app_handles.hInstance, nullptr);
	if (!app_handles.hwnd_cod4_path_button)
		return false;
	...
	(void)CreateWindowExA(0, "Static", "Call of Duty 5 installation path:", WS_CHILD | WS_VISIBLE | SS_LEFT, 10, 345, 200, 25, app_handles.hwnd_configuration_dialog, nullptr, app_handles.hInstance, nullptr);

	app_handles.hwnd_cod5_path_edit = CreateWindowExA(0, "Edit", nullptr, WS_CHILD | WS_VISIBLE | WS_BORDER | ES_MULTILINE | ES_AUTOHSCROLL | WS_HSCROLL, 220, 340, 450, 40, app_handles.hwnd_configuration_dialog, (HMENU)ID_EDIT_CONFIGURATION_COD5_PATH, app_handles.hInstance, nullptr);
	...
	app_handles.hwnd_cod5_path_button = CreateWindowExA(NULL, "Button", "Browse for cod5mp.exe", BS_PUSHBUTTON | BS_CENTER | BS_VCENTER | WS_VISIBLE | WS_CHILD, 680, 350, 190, 25, app_handles.hwnd_configuration_dialog, (HMENU)ID_BUTTON_CONFIGURATION_COD5_PATH, app_handles.hInstance, nullptr);
	if (!app_handles.hwnd_cod5_path_button)
		return false;
	...
	app_handles.hwnd_re_confirmation_message = CreateWindowExA(0, RICHEDIT_CLASSA, nullptr, WS_BORDER | WS_VISIBLE | WS_CHILD | WS_VSCROLL | ES_MULTILINE | ES_LEFT | ES_AUTOVSCROLL | ES_READONLY, 220, 390, 450, 260, app_handles.hwnd_configuration_dialog, nullptr, app_handles.hInstance, nullptr);
	if (!app_handles.hwnd_re_confirmation_message)
		return false;
	...
	app_handles.hwnd_save_settings_button = CreateWindowExA(NULL, "Button", "Save changes", BS_PUSHBUTTON | BS_CENTER | BS_VCENTER | WS_VISIBLE | WS_CHILD, 220, 660, 120, 25, app_handles.hwnd_configuration_dialog, (HMENU)ID_BUTTON_SAVE_CHANGES, app_handles.hInstance, nullptr);
	if (!app_handles.hwnd_save_settings_button)
		return false;
	...
	app_handles.hwnd_test_connection_button = CreateWindowExA(NULL, "Button", "Test connection", BS_PUSHBUTTON | BS_CENTER | BS_VCENTER | WS_VISIBLE | WS_CHILD, 360, 660, 140, 25, app_handles.hwnd_configuration_dialog, (HMENU)ID_BUTTON_TEST_CONNECTION, app_handles.hInstance, nullptr);
	...
	app_handles.hwnd_close_button = CreateWindowExA(NULL, "Button", "Cancel", BS_PUSHBUTTON | BS_CENTER | BS_VCENTER | WS_VISIBLE | WS_CHILD, 520, 660, 60, 25, app_handles.hwnd_configuration_dialog, (HMENU)ID_BUTTON_CANCEL, app_handles.hInstance, nullptr);
	...
	app_handles.hwnd_exit_tinyrcon_button = CreateWindowExA(NULL, "Button", "Exit TinyRcon", BS_PUSHBUTTON | BS_CENTER | BS_VCENTER | WS_VISIBLE | WS_CHILD, 600, 660, 120, 25, app_handles.hwnd_configuration_dialog, reinterpret_cast<HMENU>(ID_BUTTON_CONFIGURATION_EXIT_TINYRCON), app_handles.hInstance, nullptr);
  ...
  SendMessage(app_handles.hwnd_enable_country_ban, BM_SETCHECK, main_app.get_game_server().get_is_automatic_country_kick_enabled() ? BST_CHECKED : BST_UNCHECKED, 0);*/
	...
	if (!main_app.get_codmp_exe_path().empty() && (main_app.get_codmp_exe_path().find(cod1_steam_applaunch_id) != wstring::npos || check_if_file_path_exists(main_app.get_codmp_exe_path().c_str())))
	{
	...
	else
	{
		...
		if (!found_cod1_path.empty() && (found_cod1_path.find(cod1_steam_applaunch_id) != wstring::npos || check_if_file_path_exists(found_cod1_path.c_str())))
		{
	...
	if (!main_app.get_cod2mp_exe_path().empty() && (main_app.get_cod2mp_exe_path().find(cod2_steam_applaunch_id) != wstring::npos || check_if_file_path_exists(main_app.get_cod2mp_exe_path().c_str())))
	{
	...
	else
	{
		...
		if (!found_cod2_path.empty() && (found_cod2_path.find(cod2_steam_applaunch_id) != wstring::npos || check_if_file_path_exists(found_cod2_path.c_str())))
		{
	...
	if (!main_app.get_iw3mp_exe_path().empty() && (main_app.get_iw3mp_exe_path().find(cod4_steam_applaunch_id) != wstring::npos || check_if_file_path_exists(main_app.get_iw3mp_exe_path().c_str())))
	{
	...
	else
	{
		...
		if (!found_cod4_path.empty() && (found_cod4_path.find(cod4_steam_applaunch_id) != wstring::npos || check_if_file_path_exists(found_cod4_path.c_str())))
		{
	...
	if (!main_app.get_cod5mp_exe_path().empty() && (main_app.get_cod5mp_exe_path().find(cod5_steam_applaunch_id) != wstring::npos || check_if_file_path_exists(main_app.get_cod5mp_exe_path().c_str())))
	{
	...
	else
	{
		...
		if (!found_cod5_path.empty() && (found_cod5_path.find(cod5_steam_applaunch_id) != wstring::npos || check_if_file_path_exists(found_cod5_path.c_str())))
		{
...
void process_button_save_changes_click_event(HWND hwnd)
{
	...
	if (!is_invalid_entry)
	{
		...
		else
		{
			is_invalid_entry = true;
			print_colored_text(app_handles.hwnd_re_confirmation_message,
							   "^1Server name cannot be left empty!\n",
							   is_append_message_to_richedit_control::yes,
							   is_log_message::no,
							   is_log_datetime::no);
		}
	...
	if (!is_invalid_entry)
	{
		...
		auto [test_result, game_name] = check_if_specified_server_ip_port_and_rcon_password_are_valid(new_server_ip.c_str(),
																									  new_port,
																									  new_rcon_password.c_str());
		if (test_result)
		{
			main_app.get_current_game_server().set_is_connection_settings_valid(true);
			set_admin_actions_buttons_active(TRUE, false);
			print_colored_text(app_handles.hwnd_re_confirmation_message,
							   "^2Testing connection SUCCEEDED!\n",
							   is_append_message_to_richedit_control::yes,
							   is_log_message::no,
							   is_log_datetime::no);
		}
		...
		if (str_contains(path_buffer, format("-applaunch {}", cod1_steam_appid).c_str(), 0U, true) || check_if_file_path_exists(path_buffer))
		{
		...
		trim_in_place(path_buffer);
		if (str_contains(path_buffer, format("-applaunch {}", cod2_steam_appid).c_str(), 0U, true) || check_if_file_path_exists(path_buffer))
		{
		...
		trim_in_place(path_buffer);
		if (str_contains(path_buffer, format("-applaunch {}", cod4_steam_appid).c_str(), 0U, true) || check_if_file_path_exists(path_buffer))
		{
		...
		trim_in_place(path_buffer);
		if (str_contains(path_buffer, format("-applaunch {}", cod5_steam_appid).c_str(), 0u, true) || check_if_file_path_exists(path_buffer))
		{
		...
		write_tiny_rcon_json_settings_to_file(main_app.get_tinyrcon_config_file_path());
		print_colored_text(app_handles.hwnd_re_confirmation_message,
						   "^2Displayed server configuration settings have been successfully saved!\n",
						   is_append_message_to_richedit_control::yes,
						   is_log_message::no,
						   is_log_datetime::no);
		MessageBox(hwnd,
				   "Displayed server configuration settings have been successfully saved!",
				   "Successfully saved server settings",
	...
	else
	{
		print_colored_text(app_handles.hwnd_re_confirmation_message,
						   ...
						   is_log_datetime::no);
		MessageBox(hwnd,
				   "Failed to save displayed server configuration settings!",
...
void process_button_test_connection_click_event(HWND)
{
	...
	main_app.set_is_automatic_country_kick_enabled(
		Button_GetCheck(app_handles.hwnd_enable_country_ban) != BST_UNCHECKED);
...
get_rcon_map_names_to_full_map_names_for_specified_game_name(const game_name_t game_name)
{
	// print_trace_message(__FILE__, __LINE__, __FUNCTION__);
...
const std::map<std::string, std::string> &
get_rcon_gametype_names_to_full_gametype_names_for_specified_game_name(const game_name_t game_name)
{
	// print_trace_message(__FILE__, __LINE__, __FUNCTION__);
...
const std::map<std::string, std::string> &
get_full_map_names_to_rcon_map_names_for_specified_game_name(const game_name_t game_name)
{
	// print_trace_message(__FILE__, __LINE__, __FUNCTION__);
...
extract_7z_file_to_specified_path(const char *compressed_7z_file_path, const char *destination_path)
{
	// print_trace_message(__FILE__, __LINE__, __FUNCTION__);
	try
	{
...
bool save_current_user_data_to_json_file(const char *file_path)
{
	...
	{
		const string re_msg{
			format("^1Error ^3saving ^5Tiny^6Rcon ^1user's data ^3to specified file:\n\t^5{}^3Please make sure that the ^5Tiny^6Rcon ^3folder is not set to ^1read-only ^3mode.",
				   file_path)};
		print_colored_text(app_handles.hwnd_re_messages_data, re_msg.c_str());
		return false;
	}
...
void load_tinyrcon_client_user_data(const char *file_path)
{
	...
	if (!configFile)
	{
		...
		if (!configFile)
		{
			...
			const string re_msg{
				format("^1Error ^3opening ^5Tiny^6Rcon ^1user's data ^3file:\n\t^5{}\n^3Please make sure that the ^5{} ^3file\n\texists and that it is not set to ^1read-only ^3mode.",
					   file_path,
					   (f_path.has_filename() ? f_path.filename().string() : file_path))};
			print_colored_text(app_handles.hwnd_re_messages_data, re_msg.c_str());
			return;
		}
	}
	...
	u->no_of_logins = static_cast<size_t>(parts.size() >= 9 && is_valid_decimal_whole_number(parts[8], number) ? number
																											   : 0);
	u->no_of_warnings = static_cast<size_t>(parts.size() >= 10 && is_valid_decimal_whole_number(parts[9], number)
												? number
												: 0);
	u->no_of_kicks = static_cast<size_t>(parts.size() >= 11 && is_valid_decimal_whole_number(parts[10], number) ? number
																												: 0);
	u->no_of_tempbans = static_cast<size_t>(parts.size() >= 12 && is_valid_decimal_whole_number(parts[11], number)
												? number
												: 0);
	u->no_of_guidbans = static_cast<size_t>(parts.size() >= 13 && is_valid_decimal_whole_number(parts[12], number)
												? number
												: 0);
	u->no_of_ipbans = static_cast<size_t>(parts.size() >= 14 && is_valid_decimal_whole_number(parts[13], number)
											  ? number
											  : 0);
	u->no_of_iprangebans = static_cast<size_t>(parts.size() >= 15 && is_valid_decimal_whole_number(parts[14], number)
												   ? number
												   : 0);
	u->no_of_citybans = static_cast<size_t>(parts.size() >= 16 && is_valid_decimal_whole_number(parts[15], number)
												? number
												: 0);
	u->no_of_countrybans = static_cast<size_t>(parts.size() >= 17 && is_valid_decimal_whole_number(parts[16], number)
												   ? number
												   : 0);
	u->no_of_namebans = static_cast<size_t>(parts.size() >= 18 && is_valid_decimal_whole_number(parts[17], number)
												? number
												: 0);
	u->no_of_reports = static_cast<size_t>(parts.size() >= 19 && is_valid_decimal_whole_number(parts[18], number)
											   ? number
											   : 0);
}
...
bool run_executable(const char *file_path_for_executable)
{
	...
	if (CreateProcess(file_path_for_executable, nullptr, nullptr, nullptr, FALSE, 0, nullptr, nullptr, &StartupInfo, &ProcessInfo))
	{
...
bool parse_game_type_information_from_rcon_reply(const string &incoming_data_buffer, game_server &gs)
{
	...
	{
		string ex_msg3{
			format(R"(^1Exception ^3thrown from 'if (strstr(incoming_data_buffer, "g_gametype" is: ") != nullptr){{...}}'\nincoming_data_buffer="{}")",
				   incoming_data_buffer)};
...
bool parse_and_display_downloaded_game_servers_data(std::string &game_servers_data, const char *version_number, const bool is_display_parsed_game_servers_data)
{
	...
	size_t sid{main_app.get_rcon_game_servers_count()}, parsed_game_servers_count{
															main_app.get_rcon_game_servers_count()};

	const string started_parsing_message{
		format("^5Started processing ^3Call of duty 2 ^5game server related ^1getstatus ^5responses.\n^5Number of retrieved ^3Call of duty 2 v{} ^5game server addresses: ^1{}\n",
			   version_number,
	...
	for (auto &game_server_address : seen_game_server_addresses)
	{
		...
		const uint_least16_t port_number = static_cast<uint_least16_t>(stoi(
			game_server_address.substr(colon_sep_pos + 1)));
		...
		if (parse_getinfo_response_for_specified_game_server(current_game_server, number_of_online_players, number_of_max_players) || parse_getstatus_response_for_specified_game_server(current_game_server))
		{
			...
			convert_guid_key_to_country_name(main_app.get_connection_manager().get_geoip_data(),
											 current_game_server.get_server_ip_address(),
											 p);
			...
			current_game_server.set_current_full_map_name(get_full_map_name(current_game_server.get_current_map(),
																			convert_game_name_to_game_name_t(
																				current_game_server.get_game_name())));
			...
			string status_message{
				format("Processed and displayed game server related data for {} out of {} {} game servers.",
					   parsed_game_servers_count,
					   seen_game_server_addresses.size() + main_app.get_rcon_game_servers_count(),
					   version_number)};
	...
	const string finished_parsing_message{
		format("^5Finished parsing ^1getstatus ^5responses for ^3game servers' ^5related data.\n^5Number of online ^3Call of duty 2 v{} ^5game servers: ^2{}\n",
			   version_number,
			   parsed_game_servers_count)};
...
std::pair<bool, player>
remove_reported_player(std::string &ip_address, std::string &message, const bool is_report_public_message)
{
	// print_trace_message(__FILE__, __LINE__, __FUNCTION__);
	unsigned long ip_key{};
	...
	if (no < reported_players.size())
	{
		...
		if (is_report_public_message)
		{
			...
			const string buffer{
				format("^7Admin ({}^7) has successfully removed previously ^1reported player ^7{}. ^7Reason: ^1{}",
					   main_app.get_username(),
					   found_iter->player_name,
					   remove_disallowed_character_in_string(found_iter->reason))};
			message.assign(buffer);
