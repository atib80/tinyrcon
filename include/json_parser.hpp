...
inline 
int seek_next (std::string*, int, char) {
    
}

inline 
void RSJresource::fast_parse (std::string* str_p, bool, size_t, size_t* parse_start_str_pos) {
...
inline 
RSJresource& RSJresource::operator[] (const size_t indx) { // returns reference
    as_array();
