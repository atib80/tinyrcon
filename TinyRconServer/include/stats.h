...
class stats
{
  public:
    stats();
    std::mutex &get_stats_data_mutex() noexcept
    {
        return stats_data_mu;
    }
    ...
    time_t get_stop_time_in_seconds_for_year() const noexcept
    {
        return stop_time_in_seconds_for_year;
    }
    time_t get_stop_time_in_seconds_for_month() const noexcept
    {
        return stop_time_in_seconds_for_month;
    }
    time_t get_stop_time_in_seconds_for_day() const noexcept
    {
        return stop_time_in_seconds_for_day;
    }

    std::vector<player_stats> &get_scores_vector() noexcept
    {
        return scores_vector;
    }
    std::vector<player_stats> &get_scores_for_year_vector() noexcept
    {
        return scores_for_year_vector;
    }
    std::vector<player_stats> &get_scores_for_month_vector() noexcept
    {
        return scores_for_month_vector;
    }
    std::vector<player_stats> &get_scores_for_day_vector() noexcept
    {
        return scores_for_day_vector;
    }

    std::unordered_map<std::string, player_stats> &get_scores_map() noexcept
    {
        return scores_map;
    }
    std::unordered_map<std::string, player_stats> &get_scores_for_year_map() noexcept
    {
        return scores_for_year_map;
    }
    std::unordered_map<std::string, player_stats> &get_scores_for_month_map() noexcept
    {
        return scores_for_month_map;
    }
    std::unordered_map<std::string, player_stats> &get_scores_for_day_map() noexcept
    {
        return scores_for_day_map;
    }

    std::unordered_map<std::string, std::pair<int, time_t>> &get_previous_player_score_and_timestamp() noexcept
    {
        return previous_player_score_and_timestamp;
    };
