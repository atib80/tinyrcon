...
class tiny_rcon_client_application
{
  ...
  game_name_t game_name{ game_name_t::cod2 };
  ...
  std::unordered_map<int, std::string> pid_to_ip_address;
...
public:
  ...
  inline const string &get_codmp_exe_path() noexcept
  {
  ...
  inline const string &get_cod2mp_exe_path() noexcept
  {
  ...
  inline const string &get_iw3mp_exe_path() noexcept
  {
  ...
  inline const string &get_cod5mp_exe_path() noexcept
  {
  ...
  std::unordered_map<int, std::string> &get_pid_to_ip_address() noexcept
  {
    return pid_to_ip_address;
  }

  const std::unordered_map<int, std::string> &get_pid_to_ip_address() const noexcept
  {
    return pid_to_ip_address;
  }
  ...
  std::vector<std::shared_ptr<tiny_rcon_client_user>> &get_remote_users() noexcept
  {
    return remote_users;
  }
  ...
  std::string get_user_defined_warn_message() noexcept
  {
    return admin_messages["user_defined_warn_msg"];
  }

  std::string get_user_defined_kick_message() noexcept
  {
    return admin_messages["user_defined_kick_msg"];
  }

  std::string get_user_defined_tempban_message() noexcept
  {
    return admin_messages["user_defined_temp_ban_msg"];
  }

  std::string get_user_defined_ban_message() noexcept
  {
    return admin_messages["user_defined_ban_msg"];
  }

  std::string get_user_defined_ipban_message() noexcept
  {
    return admin_messages["user_defined_ip_ban_msg"];
  }

  std::string get_user_defined_ip_address_range_ban_message() noexcept
  {
    return admin_messages["user_defined_ip_address_range_ban_msg"];
  }

  std::string get_user_defined_city_ban_msg() noexcept
  {
    return admin_messages["user_defined_city_ban_msg"];
  }

  std::string get_user_defined_city_unban_msg() noexcept
  {
    return admin_messages["user_defined_city_unban_msg"];
  }

  std::string get_user_defined_enable_city_ban_feature_msg() noexcept
  {
    return admin_messages["user_defined_enable_city_ban_feature_msg"];
  }

  std::string get_user_defined_disable_city_ban_feature_msg() noexcept
  {
    return admin_messages["user_defined_disable_city_ban_feature_msg"];
  }

  std::string get_user_defined_country_ban_msg() noexcept
  {
    return admin_messages["user_defined_country_ban_msg"];
  }

  std::string get_user_defined_country_unban_msg() noexcept
  {
    return admin_messages["user_defined_country_unban_msg"];
  }

  std::string get_user_defined_enable_country_ban_feature_msg() noexcept
  {
    return admin_messages["user_defined_enable_country_ban_feature_msg"];
  }

  std::string get_user_defined_disable_country_ban_feature_msg() noexcept
  {
    return admin_messages["user_defined_disable_country_ban_feature_msg"];
  }

  std::string get_automatic_remove_temp_ban_msg() noexcept
  {
    return admin_messages["automatic_remove_temp_ban_msg"];
  }

  std::string get_automatic_kick_temp_ban_msg() noexcept
  {
    return admin_messages["automatic_kick_temp_ban_msg"];
  }

  std::string get_automatic_kick_ip_ban_msg() noexcept
  {
    return admin_messages["automatic_kick_ip_ban_msg"];
  }

  std::string get_automatic_kick_ip_address_range_ban_msg() noexcept
  {
    return admin_messages["automatic_kick_ip_address_range_ban_msg"];
  }

  std::string get_automatic_kick_city_ban_msg() noexcept
  {
    return admin_messages["automatic_kick_city_ban_msg"];
  }

  std::string get_automatic_kick_country_ban_msg() noexcept
  {
    return admin_messages["automatic_kick_country_ban_msg"];
  }

  std::string get_user_defined_protect_ip_address_message() noexcept
  {
    return admin_messages["user_defined_protect_ip_address_message"];
  }

  std::string get_user_defined_unprotect_ip_address_message() noexcept
  {
    return admin_messages["user_defined_unprotect_ip_address_message"];
  }

  std::string get_user_defined_protect_ip_address_range_message() noexcept
  {
    return admin_messages["user_defined_protect_ip_address_range_message"];
  }

  std::string get_user_defined_unprotect_ip_address_range_message() noexcept
  {
    return admin_messages["user_defined_unprotect_ip_address_range_message"];
  }

  std::string get_user_defined_protect_city_message() noexcept
  {
    return admin_messages["user_defined_protect_city_message"];
  }

  std::string get_user_defined_unprotect_city_message() noexcept
  {
    return admin_messages["user_defined_unprotect_city_message"];
  }

  std::string get_user_defined_protect_country_message() noexcept
  {
    return admin_messages["user_defined_protect_country_message"];
  }

  std::string get_user_defined_unprotect_country_message() noexcept
  {
