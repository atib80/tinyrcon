...
{
  explicit print_message_t(std::string message, is_log_message log_to_file, is_log_datetime is_log_current_date_time, const bool is_remove_color_codes_for_log_message = true, const bool is_display_message_to_remote_user = true, const bool is_send_message_to_player = false)
...
{
  explicit server_message_t(std::string message_command, std::string message_data, const std::shared_ptr<tiny_rcon_client_user> &s, const bool is_show_in_messages = true)
...
struct geoip_data
{
  ...
  geoip_data(const unsigned long lib, const unsigned long uib, const char *code, const char *country, const char *reg, const char *ci)
...
public:
  explicit text_element(const char *text, const size_t width, const char *color_code = nullptr, const bool is_left_adjusted = true)
